...
import vn.vnpt.vnptit.ecms.service.idc.LoaiLongQuayService;

@RestController
@RequestMapping("/danhmuc/loai-longquay")
public class LoaiLongQuayController {

    @Autowired
    private LoaiLongQuayService loaiLongQuayService;
    ...
    public ResponseEntity<ApiResult> get() {
        ...
        try {
            apiResult.setData(loaiLongQuayService.getListLoaiLongQuayV2());
    ...
    /**
     * Tạo mới hoặc cập nhật loại lồng quay
     */
    @PostMapping(value = "/upsert")
    public ResponseEntity<ApiResult> upsert(@RequestBody LoaiLongQuayDto dto) {
        ApiResult apiResult = new ApiResult();
        try {
            dto.isValid();
            apiResult.setData(loaiLongQuayService.saveLoaiLongQuay(dto));
        } catch (AppSqlException e) {
            apiResult.setException(e);
        }
        return apiResult.getResponseEntity();
    ...
    public ResponseEntity<ApiResult> delete(@RequestParam Long id) {
        ApiResult apiResult = new ApiResult();
        try {
            apiResult.setData(loaiLongQuayService.delete(id));
        } catch (AppSqlException e) {
            apiResult.setException(e);
        }
        return apiResult.getResponseEntity();
    ...
    public ResponseEntity<ApiResult> validateFile(@RequestBody List<Map<String, Object>> userInput) {
        ...
        try {
            Map<String, Object> result = loaiLongQuayService.validateFile(userInput);
    ...
    public ResponseEntity<ApiResult> uploadFile(@RequestBody List<Map<String, Object>> userInput) {
        ...
        try {
            ...
            apiResult.setData(loaiLongQuayService.saveFile(jsonDataList));
