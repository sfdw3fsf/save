...
public class KhoHaTangAoHoaCloudDTO {
    private int id;
    ...
    private List<KhoHaTangThietBiHinhThanhDTO> thietBiDauNoiList = new ArrayList<>();

    public List<KhoHaTangThietBiHinhThanhDTO> getThietBiDauNoiList() {
        return thietBiDauNoiList;
    }
