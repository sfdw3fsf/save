...
public class SearchPycTaiNguyenDto implements Serializable {
    ...
    public Long getLoaiDichVuId() {
        return loaiDichVuId;
    }

    public void setLoaiDichVuId(Long loaiDichVuId) {
