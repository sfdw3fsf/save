...
@Service
public class DanhMucCongNgheService {

    private final DbContext dbContext;

    public DanhMucCongNgheService(DbContext dbContext) {
    ...
    public Object getAll() throws AppSqlException {
        ...
        return dbContext.executeSpWithCursorToListMap(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_GET_CONGNGHE_LIST",
                params
        );
    }
    ...
    public Object getDetail(Long id) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_GET_CONGNGHE_BY_ID",
                params
        );
    ...
    // INSERT / UPDATE
    // ===========================================
    public ApiResult insertOrUpdate(UpsertCongNgheDto dto) throws AppSqlException {
        ...
        params.add(new SqlParameter("p_loaiht_id", dto.getLoaiHaTangId(), Types.NUMERIC));
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_INSERT_UPDATE_CONGNGHE",
                params
        );
    ...
    public ApiResult delete(Long id) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_DELETE_CONGNGHE",
                params
        );
    ...
    public ApiResult deleteMulti(String listId) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_DELETE_MULTI_CONGNGHE",
                params
        );
    ...
    public boolean checkTenTonTai(Long id, String ten) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_CHECK_CONGNGHE_TEN",
                params
        );
    ...
    public boolean checkTenTatTonTai(Long id, String tenTat) throws AppSqlException {
        ...
        params.add(exist);
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_CHECK_CONGNGHE_TENTAT",
                params
        );
        return toInt(exist.getOutValue()) > 0;
    }

    public ApiResult checkListCongNghe(List<UpsertCongNgheDto> list) throws AppSqlException, JsonProcessingException {
        ...
        dbContext.executeStoredProcedure("ECMS.PKG_IDC_TAINGUYEN_V2.SP_VALIDATE_LIST_CONGNGHE", params);
