...
@Service
public class ThuHoiRackService {
    private final DbContext dbContext;

    public ThuHoiRackService(DbContext dbContext) {
        this.dbContext = dbContext;
    }

    public ArrayList<Map<String, Object>> thiCongThuHoiRack(CapPhatRackRequestDTO request) throws AppSqlException {
        ...
        return dbContext.executeSpWithCursorToListMap("ECMS.PKG_IDC_TUANLN.THICONG_THUHOI_RACK", params);
    }

    public ArrayList<Map<String, Object>> xoaThiCongThuHoiRack(CapPhatRackRequestDTO request) throws AppSqlException {
        AppRequestContext context = AppRequestContext.getCurrent();
        ...
        params.add(new SqlParameter("p_nhanvien_id", context.getNhanVienID(), SqlParameter.ParameterDirection.INPUT, Types.NUMERIC));
        params.add(new SqlParameter("p_result", null, SqlParameter.ParameterDirection.OUTPUT, Types.REF_CURSOR));
        return dbContext.executeSpWithCursorToListMap("ECMS.PKG_IDC_TUANLN.XOA_THICONG_THUHOI_RACK", params);
    }
    ...
    public ArrayList<Map<String, Object>> hoanThanh(Long idPhieuThiCong) throws AppSqlException {
        ...
        params.add(new SqlParameter("p_nguoi_cn", AppRequestContext.getCurrent().getUserName(), SqlParameter.ParameterDirection.INPUT, Types.VARCHAR));
        params.add(new SqlParameter("p_result", null, SqlParameter.ParameterDirection.OUTPUT, Types.REF_CURSOR));
        return dbContext.executeSpWithCursorToListMap("ECMS.PKG_IDC_TUANLN.HOANTHANH_THUHOI_RACK", params);
    }

    public ArrayList<Map<String, Object>> dsKetQuaThiCong(KetQuaThiCongRackDto dto) throws AppSqlException {
        ArrayList<SqlParameter> parameters = new ArrayList<>();
        parameters.add(new SqlParameter("p_loaicv_id", 62, SqlParameter.ParameterDirection.INPUT, Types.NUMERIC));
    ...
    public ArrayList<Map<String, Object>> dsSanSangThuHoi(Long idPhieuThiCong) throws AppSqlException {
        ArrayList<SqlParameter> params = new ArrayList<>();
        params.add(new SqlParameter("p_result", null, SqlParameter.ParameterDirection.OUTPUT, Types.REF_CURSOR));
        params.add(new SqlParameter("p_phieutc_id", idPhieuThiCong, SqlParameter.ParameterDirection.INPUT, Types.NUMERIC));
        return dbContext.executeSpWithCursorToListMap("ECMS.PKG_IDC_TUANLN.DS_SANSANG_THUHOI_RACK", params);
    }
}
