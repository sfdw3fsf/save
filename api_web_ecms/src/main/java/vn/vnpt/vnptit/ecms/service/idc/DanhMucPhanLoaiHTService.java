...
@Service
public class DanhMucPhanLoaiHTService {

    private final DbContext dbContext;

    public DanhMucPhanLoaiHTService(DbContext dbContext) {
    ...
    public Object getAll() throws AppSqlException {
        ...
        return dbContext.executeSpWithCursorToListMap(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_GET_PHANLOAIHT_LIST",
                params
        );
    }
    ...
    public Object getDetail(Long id) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_GET_PHANLOAIHT_BY_ID",
                params
        );
    ...
    // INSERT / UPDATE
    // ===========================================
    public ApiResult insertOrUpdate(UpsertPhanLoaiHTDto dto) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_INSERT_UPDATE_PHANLOAIHT",
                params
        );
    ...
    public ApiResult delete(Long id) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_DELETE_PHANLOAIHT",
                params
        );
    ...
    public ApiResult deleteMulti(String listId) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_DELETE_MULTI_PHANLOAIHT",
                params
        );
    ...
    public boolean checkTenTonTai(Long id, String ten) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_CHECK_PHANLOAIHT_TEN",
                params
        );
    ...
    public boolean checkTenTatTonTai(Long id, String tenTat) throws AppSqlException {
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_CHECK_PHANLOAIHT_TENTAT",
                params
        );
    ...
    // VALIDATE LIST
    // ===========================================
    public ApiResult checkListPhanLoaiHT(List<UpsertPhanLoaiHTDto> list)
        ...
        dbContext.executeStoredProcedure(
                "ECMS.PKG_IDC_TAINGUYEN_V2.SP_VALIDATE_LIST_PHANLOAIHT",
                params
        );
