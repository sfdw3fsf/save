...
public class SoDoKetNoiMangDto implements Serializable {
    ...
    public SoDoKetNoiMangDto() {
    }

    public SoDoKetNoiMangDto(Long idcId, Long thietBiId, Long thietbiKetnoiId, Long portThietbiId,
