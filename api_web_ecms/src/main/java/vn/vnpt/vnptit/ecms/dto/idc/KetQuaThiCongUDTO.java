...
public class KetQuaThiCongUDTO implements Serializable {
    ...
    public KetQuaThiCongUDTO() {
    }

    public KetQuaThiCongUDTO(Long loaiCvId, Long donviId, Long trangthaiId, Long nhanvienThId, Date ngayYcStart, Date ngayYcEnd, Date ngayYchtStart, Date ngayYchtEnd, Integer phanLoai, String khachHang, String congViec, Long idcId, String tenU) {
