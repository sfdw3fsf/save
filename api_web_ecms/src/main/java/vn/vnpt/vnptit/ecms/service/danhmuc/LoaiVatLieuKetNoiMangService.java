...
@Service
public class LoaiVatLieuKetNoiMangService {
    @Autowired
    DbContext dbContext;
    ...
    public ArrayList<Map<String, Object>> getList()  throws AppSqlException {
        ...
        return dbContext.executeSpWithCursorToListMap("ECMS.PKG_HATANG_2.SP_LOAIVATLIEU_KETNOIMANG_DS", parameters);
    }
    ...
    public Boolean update(String input)  throws AppSqlException {
        ...
        ArrayList<Map<String, Object>> rs = dbContext.executeSpWithCursorToListMap("ECMS.PKG_HATANG_2.SP_LOAIVATLIEU_KETNOIMANG_CAPNHAT", parameters);
    ...
    public Boolean delete(Long input)  throws AppSqlException {
        ...
        ArrayList<Map<String, Object>> rs = dbContext.executeSpWithCursorToListMap("ECMS.PKG_HATANG_2.SP_LOAIVATLIEU_KETNOIMANG_DELETE", parameters);
        if (rs != null && !rs.isEmpty()){
            if ("1".equals(String.valueOf(rs.get(0).get("item"))))
                return Boolean.TRUE;
        }
