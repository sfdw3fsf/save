...
public class HeDieuHanhService {
    ...
    public HeDieuHanhService(DbContext dbContext) {
    ...
    public Object getItems() throws AppSqlException {
        ...
        return dbContext.executeSpWithCursorToListMap("ECMS.pkg_hatang_danhmuc.sp_he_dieu_hanh_get_all", params);
    }
    ...
    public Object insert(MucDichSuDungCongDto item) throws AppSqlException {
        ...
        params.add(result);
        dbContext.executeStoredProcedure("ECMS.pkg_hatang_danhmuc.sp_he_dieu_hanh_insert", params);
    ...
    public Object update(MucDichSuDungCongDto item) throws AppSqlException {
        ...
        SqlParameter result = new SqlParameter("p_result", Types.NUMERIC);
        params.add(result);
        dbContext.executeStoredProcedure("ECMS.pkg_hatang_danhmuc.sp_he_dieu_hanh_update", params);
        return result.getOutValue();
    }
    ...
    public Object delete(String ids) throws AppSqlException {
        ...
        SqlParameter result = new SqlParameter("p_result", Types.NUMERIC);
        params.add(result);
        dbContext.executeStoredProcedure("ECMS.pkg_hatang_danhmuc.sp_he_dieu_hanh_delete", params);
        return result.getOutValue();
    }
}
