...
public class LoaiLongQuayDto {
    @JsonProperty("id")
    public Long loaiLongQuayId;
    @JsonProperty("ten")
    public String ten;
    @JsonProperty("tentat")
    ...
    public Long getLoaiLongQuayId() {
        return loaiLongQuayId;
    }

    public void setLoaiLongQuayId(Long loaiLongQuayId) {
        this.loaiLongQuayId = loaiLongQuayId;
    }
