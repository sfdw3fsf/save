...
import { getMaterialDetailApi, materialFuneralKeys } from '@/store/material/material.api';
...
type MFS_DetailProductInformationProps = {
  id: number;
};

const MFS_DetailProductInformation = ({ id }: MFS_DetailProductInformationProps) => {
  ...
  const { data: materialDetailData } = useQuery({
    queryKey: materialFuneralKeys.detail(id),
      ...
      <Row gutter={[24, 16]}>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            name='type'
            type={InputEnum.TEXT}
            label={tFuneralSupplies('detail.type')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            label={tFuneralSupplies('detail.unit_price')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            label={tFuneralSupplies('detail.business_partner')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tFuneralSupplies('detail.business_partnerManager')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            name='vendorContact'
            type={InputEnum.TEXT}
            label={tFuneralSupplies('detail.contact_number')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tFuneralSupplies('detail.deposit_account')}
          />
        </Col>
        <Col span={24}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tFuneralSupplies('detail.business_registration_number')}
          />
        </Col>
        <Col span={24}>
          <CustomFormInput
...
export default MFS_DetailProductInformation;
