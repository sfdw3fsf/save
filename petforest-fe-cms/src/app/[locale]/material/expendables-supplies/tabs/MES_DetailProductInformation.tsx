...
import { getMaterialDetailApi, materialExpendablesKeys } from '@/store/material/material.api';
...
type MES_DetailProductInformationProps = {
  id: number;
};

const MES_DetailProductInformation = ({ id }: MES_DetailProductInformationProps) => {
  ...
  const { data: materialDetailData } = useQuery({
    queryKey: materialExpendablesKeys.detail(id),
      ...
      <Row gutter={[24, 16]}>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            label={tExpendablesSupplies('detail.unit_price')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            label={tExpendablesSupplies('detail.business_partner')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tExpendablesSupplies('detail.business_partnerManager')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            name='vendorContact'
            type={InputEnum.TEXT}
            label={tExpendablesSupplies('detail.contact_number')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tExpendablesSupplies('detail.deposit_account')}
          />
        </Col>
        <Col span={colSpan}>
          <CustomFormInput
            ...
            type={InputEnum.TEXT}
            label={tExpendablesSupplies('detail.business_registration_number')}
          />
        </Col>
        <Col span={24}>
          <CustomFormInput
...
export default MES_DetailProductInformation;
