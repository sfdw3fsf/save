...
export const MOFS_Columns = ({
  onDetail,
  onUpdateMaterial,
  onUpdateMaterialStatus,
}: MOFS_ColumnsProps): TableColumnsType<MaterialDTO> => {
  ...
  return [
    {
      title: <EditableHeader title={tOtherSupplies('table.type')} />,
      dataIndex: 'type',
      sorter: true,
      width: 100,
    ...
    {
      title: <EditableHeader title={tOtherSupplies('table.name')} />,
      dataIndex: 'name',
      sorter: true,
      width: 100,
      render: (text: string, record: any) => (
    ...
    {
      title: tOtherSupplies('table.current_situation'),
    ...
    {
      title: <EditableHeader title={tOtherSupplies('table.active')} />,
      dataIndex: 'status',
      width: 150,
