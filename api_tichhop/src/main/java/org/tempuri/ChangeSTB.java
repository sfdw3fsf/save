...
/**
 *  ChangeSTB bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSTB implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSTB", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSTB", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ChangeSTB parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            ChangeSTB object = new ChangeSTB();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSTB".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSTB) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
