...
/**
 *  ChangeStatusHotelVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeStatusHotelVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeStatusHotelVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeStatusHotelVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeStatusHotelVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeStatusHotelVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeStatusHotelVO object = new ChangeStatusHotelVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeStatusHotelVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeStatusHotelVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
