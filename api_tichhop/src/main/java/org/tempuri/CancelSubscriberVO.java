...
/**
 *  CancelSubscriberVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CancelSubscriberVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = CancelSubscriberVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CancelSubscriberVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CancelSubscriberVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CancelSubscriberVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CancelSubscriberVO object = new CancelSubscriberVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CancelSubscriberVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CancelSubscriberVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
