...
/**
 *  ChangePromotionsVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePromotionsVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangePromotionsVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePromotionsVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePromotionsVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangePromotionsVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePromotionsVO object = new ChangePromotionsVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePromotionsVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePromotionsVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
