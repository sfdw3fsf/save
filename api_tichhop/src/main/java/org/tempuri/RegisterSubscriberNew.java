...
/**
 *  RegisterSubscriberNew bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterSubscriberNew implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "RegisterSubscriberNew", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RegisterSubscriberNew", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RegisterSubscriberNew", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegisterSubscriberNew parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterSubscriberNew object = new RegisterSubscriberNew();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegisterSubscriberNew".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterSubscriberNew) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
