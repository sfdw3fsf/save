...
/**
 *  STB_Prom_BuyDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class STB_Prom_BuyDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = STB_Prom_BuyDTO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":STB_Prom_BuyDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "STB_Prom_BuyDTO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static STB_Prom_BuyDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            STB_Prom_BuyDTO object = new STB_Prom_BuyDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"STB_Prom_BuyDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (STB_Prom_BuyDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
