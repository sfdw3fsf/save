...
/**
 *  ValidPasswordVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ValidPasswordVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ValidPasswordVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ValidPasswordVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ValidPasswordVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ValidPasswordVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValidPasswordVO object = new ValidPasswordVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValidPasswordVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ValidPasswordVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
