...
/**
 *  MethodChangePay bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MethodChangePay implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MethodChangePay", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MethodChangePay", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MethodChangePay parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MethodChangePay object = new MethodChangePay();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MethodChangePay".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MethodChangePay) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
