...
/**
 *  STB_Prom_SummaryDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class STB_Prom_SummaryDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = STB_Prom_SummaryDTO
     ...
     * @param param COMBO
     */
    public void setCOMBO(int param) {
        this.localCOMBO = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":STB_Prom_SummaryDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "STB_Prom_SummaryDTO", xmlWriter);
            }
        }
        ...
        namespace = "http://tempuri.org/";
        writeStartElement(null, namespace, "PSC", xmlWriter);

        if (localPSC == java.lang.Integer.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
                "PSC cannot be null!!");
        } else {
        ...
        namespace = "http://tempuri.org/";
        writeStartElement(null, namespace, "COMBO", xmlWriter);

        if (localCOMBO == java.lang.Integer.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
                "COMBO cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCOMBO));
        }
    ...
    public static class Factory {
         ...
         */
        public static STB_Prom_SummaryDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            STB_Prom_SummaryDTO object = new STB_Prom_SummaryDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"STB_Prom_SummaryDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (STB_Prom_SummaryDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "PSC" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setPSC(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "COMBO" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setCOMBO(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
