...
/**
 *  GetBillByContentVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetBillByContentVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = GetBillByContentVO
     ...
     * field for Data
     */
    protected org.tempuri.Data_type1 localData;
     ...
     * @return org.tempuri.Data_type1
     */
    public org.tempuri.Data_type1 getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(org.tempuri.Data_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetBillByContentVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetBillByContentVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetBillByContentVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetBillByContentVO object = new GetBillByContentVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetBillByContentVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetBillByContentVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setData(org.tempuri.Data_type1.Factory.parse(reader));
