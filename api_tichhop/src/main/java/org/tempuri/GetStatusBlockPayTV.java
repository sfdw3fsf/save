...
/**
 *  GetStatusBlockPayTV bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusBlockPayTV implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "getStatusBlockPayTV", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getStatusBlockPayTV", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getStatusBlockPayTV", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusBlockPayTV parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusBlockPayTV object = new GetStatusBlockPayTV();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getStatusBlockPayTV".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusBlockPayTV) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
