...
/**
 *  ChangeSubscriberV2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSubscriberV2 implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "ChangeSubscriberV2", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSubscriberV2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSubscriberV2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeSubscriberV2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeSubscriberV2 object = new ChangeSubscriberV2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSubscriberV2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSubscriberV2) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
