...
/**
 *  ValidPassword bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ValidPassword implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ValidPassword", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ValidPassword", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ValidPassword parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValidPassword object = new ValidPassword();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValidPassword".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ValidPassword) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
