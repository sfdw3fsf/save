...
/**
 *  ChangeSystemReq bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSystemReq implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeSystemReq
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSystemReq", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSystemReq", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeSystemReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeSystemReq object = new ChangeSystemReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSystemReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSystemReq) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
