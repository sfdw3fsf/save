...
/**
 *  GetSTBInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetSTBInfo implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetSTBInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetSTBInfo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetSTBInfo parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetSTBInfo object = new GetSTBInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetSTBInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetSTBInfo) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
