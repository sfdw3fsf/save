...
/**
 *  ChangeContract bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeContract implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isContractNoSpecified() {
        return localContractNoTracker;
    }
    ...
    public void setContractNo(java.lang.String param) {
        localContractNoTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeContract", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeContract", xmlWriter);
            }
        }
        ...
        if (localContractNoTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "ContractNo", xmlWriter);

            if (localContractNo == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "ContractNo cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static ChangeContract parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeContract object = new ChangeContract();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeContract".equals(type)) {
                            ...
                            return (ChangeContract) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "ContractNo").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "ContractNo" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setContractNo(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
