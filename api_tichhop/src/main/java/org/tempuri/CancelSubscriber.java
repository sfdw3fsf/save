...
/**
 *  CancelSubscriber bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CancelSubscriber implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "CancelSubscriber", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CancelSubscriber", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CancelSubscriber", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CancelSubscriber parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CancelSubscriber object = new CancelSubscriber();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CancelSubscriber".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CancelSubscriber) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
