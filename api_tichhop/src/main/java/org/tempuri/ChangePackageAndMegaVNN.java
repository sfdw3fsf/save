...
/**
 *  ChangePackageAndMegaVNN bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePackageAndMegaVNN implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "ChangePackageAndMegaVNN", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePackageAndMegaVNN", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePackageAndMegaVNN", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangePackageAndMegaVNN parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePackageAndMegaVNN object = new ChangePackageAndMegaVNN();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePackageAndMegaVNN".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePackageAndMegaVNN) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
