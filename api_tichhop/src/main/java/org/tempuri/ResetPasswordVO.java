...
/**
 *  ResetPasswordVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ResetPasswordVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ResetPasswordVO
    ...
    /**
     * field for PasswordOld
     */
    protected java.lang.String localPasswordOld;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localPasswordOldTracker = false;
    ...
    public boolean isPasswordOldSpecified() {
        return localPasswordOldTracker;
    }
     ...
     */
    public void setPasswordOld(java.lang.String param) {
        localPasswordOldTracker = param != null;

        this.localPasswordOld = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ResetPasswordVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ResetPasswordVO", xmlWriter);
            }
        }
        ...
        if (localPasswordOldTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "PasswordOld", xmlWriter);

            if (localPasswordOld == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "PasswordOld cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localPasswordOld);
            }
    ...
    public static class Factory {
         ...
         */
        public static ResetPasswordVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ResetPasswordVO object = new ResetPasswordVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResetPasswordVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ResetPasswordVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "PasswordOld").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "PasswordOld" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setPasswordOld(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
