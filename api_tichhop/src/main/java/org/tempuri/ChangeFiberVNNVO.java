...
/**
 *  ChangeFiberVNNVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeFiberVNNVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeFiberVNNVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeFiberVNNVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeFiberVNNVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeFiberVNNVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeFiberVNNVO object = new ChangeFiberVNNVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeFiberVNNVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeFiberVNNVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
