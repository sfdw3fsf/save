...
/**
 *  DeleteHotel bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DeleteHotel implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DeleteHotel", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DeleteHotel", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DeleteHotel parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DeleteHotel object = new DeleteHotel();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteHotel".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DeleteHotel) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
