...
/**
 *  SuspendSubscriber bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SuspendSubscriber implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "SuspendSubscriber", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SuspendSubscriber", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SuspendSubscriber", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SuspendSubscriber parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SuspendSubscriber object = new SuspendSubscriber();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SuspendSubscriber".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SuspendSubscriber) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
