...
/**
 *  ChangePromotionsV2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePromotionsV2 implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "ChangePromotionsV2", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePromotionsV2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePromotionsV2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangePromotionsV2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePromotionsV2 object = new ChangePromotionsV2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePromotionsV2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePromotionsV2) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setOption(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
