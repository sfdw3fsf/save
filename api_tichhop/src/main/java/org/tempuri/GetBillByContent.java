...
/**
 *  GetBillByContent bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetBillByContent implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "GetBillByContent", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetBillByContent", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetBillByContent", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetBillByContent parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetBillByContent object = new GetBillByContent();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetBillByContent".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetBillByContent) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
