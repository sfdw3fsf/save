...
/**
 *  MyTVPlusRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MyTVPlusRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = MyTVPlusRequest
    ...
    /**
     * field for OperatorCD
     */
    protected java.lang.String localOperatorCD;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localOperatorCDTracker = false;
    ...
    public boolean isOperatorCDSpecified() {
        return localOperatorCDTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getOperatorCD() {
        return localOperatorCD;
    }

    /**
     * Auto generated setter method
     * @param param OperatorCD
     */
    public void setOperatorCD(java.lang.String param) {
        localOperatorCDTracker = param != null;

        this.localOperatorCD = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MyTVPlusRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MyTVPlusRequest", xmlWriter);
            }
        }
        ...
        if (localOperatorCDTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "OperatorCD", xmlWriter);

            if (localOperatorCD == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "OperatorCD cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localOperatorCD);
            }
    ...
    public static class Factory {
         ...
         */
        public static MyTVPlusRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MyTVPlusRequest object = new MyTVPlusRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MyTVPlusRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MyTVPlusRequest) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "OperatorCD").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "OperatorCD" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setOperatorCD(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
