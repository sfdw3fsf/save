...
/**
 *  ChangeBillCodeVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeBillCodeVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeBillCodeVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeBillCodeVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeBillCodeVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeBillCodeVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeBillCodeVO object = new ChangeBillCodeVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeBillCodeVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeBillCodeVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
