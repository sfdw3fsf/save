...
/**
 *  EditHotelVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EditHotelVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EditHotelVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EditHotelVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EditHotelVO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            EditHotelVO object = new EditHotelVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EditHotelVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EditHotelVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
