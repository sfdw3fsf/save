...
/**
 *  EditHotel bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EditHotel implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EditHotel", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EditHotel", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static EditHotel parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            EditHotel object = new EditHotel();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EditHotel".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EditHotel) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
