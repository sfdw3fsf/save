...
/**
 *  AddHotelVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddHotelVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AddHotelVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AddHotelVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AddHotelVO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AddHotelVO object = new AddHotelVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AddHotelVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddHotelVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
