...
/**
 *  ChangeSystemResp bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSystemResp implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeSystemResp
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSystemResp", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSystemResp", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeSystemResp parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeSystemResp object = new ChangeSystemResp();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSystemResp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSystemResp) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
