...
/**
 *  CancelAddOnDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CancelAddOnDTO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CancelAddOnDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CancelAddOnDTO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CancelAddOnDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CancelAddOnDTO object = new CancelAddOnDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CancelAddOnDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CancelAddOnDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
