...
/**
 *  STB_PromDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class STB_PromDTO implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for FIBER_MYTV
     */
    protected java.lang.String localFIBER_MYTV;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localFIBER_MYTVTracker = false;
    ...
    public boolean isFIBER_MYTVSpecified() {
        return localFIBER_MYTVTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getFIBER_MYTV() {
        return localFIBER_MYTV;
    }

    /**
     * Auto generated setter method
     * @param param FIBER_MYTV
     */
    public void setFIBER_MYTV(java.lang.String param) {
        localFIBER_MYTVTracker = param != null;

        this.localFIBER_MYTV = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":STB_PromDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "STB_PromDTO", xmlWriter);
            }
        }
        ...
        if (localFIBER_MYTVTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "FIBER_MYTV", xmlWriter);

            if (localFIBER_MYTV == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "FIBER_MYTV cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localFIBER_MYTV);
            }
    ...
    public static class Factory {
         ...
         */
        public static STB_PromDTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            STB_PromDTO object = new STB_PromDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"STB_PromDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (STB_PromDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "FIBER_MYTV").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "FIBER_MYTV" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setFIBER_MYTV(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
