...
/**
 *  ChangeMegaVNN bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeMegaVNN implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeMegaVNN", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeMegaVNN", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeMegaVNN parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeMegaVNN object = new ChangeMegaVNN();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeMegaVNN".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeMegaVNN) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
