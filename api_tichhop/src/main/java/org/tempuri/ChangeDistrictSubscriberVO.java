...
/**
 *  ChangeDistrictSubscriberVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeDistrictSubscriberVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeDistrictSubscriberVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeDistrictSubscriberVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeDistrictSubscriberVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeDistrictSubscriberVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeDistrictSubscriberVO object = new ChangeDistrictSubscriberVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeDistrictSubscriberVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeDistrictSubscriberVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
