...
/**
 *  B2B_HotelPackageDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class B2B_HotelPackageDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = B2B_HotelPackageDTO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":B2B_HotelPackageDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "B2B_HotelPackageDTO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static B2B_HotelPackageDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            B2B_HotelPackageDTO object = new B2B_HotelPackageDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"B2B_HotelPackageDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (B2B_HotelPackageDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
