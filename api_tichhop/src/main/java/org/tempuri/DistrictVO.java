...
/**
 *  DistrictVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DistrictVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DistrictVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DistrictVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DistrictVO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DistrictVO object = new DistrictVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DistrictVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DistrictVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
