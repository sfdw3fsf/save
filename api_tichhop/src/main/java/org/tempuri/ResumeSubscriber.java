...
/**
 *  ResumeSubscriber bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ResumeSubscriber implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "ResumeSubscriber", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ResumeSubscriber", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ResumeSubscriber", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ResumeSubscriber parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ResumeSubscriber object = new ResumeSubscriber();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResumeSubscriber".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ResumeSubscriber) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
