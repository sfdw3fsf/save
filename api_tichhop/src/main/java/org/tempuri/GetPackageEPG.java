...
/**
 *  GetPackageEPG bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetPackageEPG implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for StrAll
     */
    protected java.lang.String localStrAll;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localStrAllTracker = false;
    ...
    public boolean isStrAllSpecified() {
        return localStrAllTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getStrAll() {
        return localStrAll;
    }
     ...
     * @param param StrAll
     */
    public void setStrAll(java.lang.String param) {
        localStrAllTracker = param != null;

        this.localStrAll = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetPackageEPG", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetPackageEPG", xmlWriter);
            }
        }
        ...
        if (localStrAllTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "strAll", xmlWriter);

            if (localStrAll == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "strAll cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localStrAll);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetPackageEPG parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPackageEPG object = new GetPackageEPG();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetPackageEPG".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetPackageEPG) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "strAll" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setStrAll(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
