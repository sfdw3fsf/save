...
/**
 *  B2BCommonVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class B2BCommonVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":b2bCommonVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "b2bCommonVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static B2BCommonVO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            B2BCommonVO object = new B2BCommonVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"b2bCommonVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (B2BCommonVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
