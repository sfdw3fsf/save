...
/**
 *  BlockPayTVResp bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BlockPayTVResp implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BlockPayTVResp", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "BlockPayTVResp", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static BlockPayTVResp parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BlockPayTVResp object = new BlockPayTVResp();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BlockPayTVResp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (BlockPayTVResp) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
