...
/**
 *  CancelSubscriberV2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CancelSubscriberV2 implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "CancelSubscriberV2", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CancelSubscriberV2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CancelSubscriberV2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CancelSubscriberV2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CancelSubscriberV2 object = new CancelSubscriberV2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CancelSubscriberV2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CancelSubscriberV2) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
