...
/**
 *  MethodChangePayVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MethodChangePayVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = MethodChangePayVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MethodChangePayVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MethodChangePayVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MethodChangePayVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MethodChangePayVO object = new MethodChangePayVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MethodChangePayVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MethodChangePayVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
