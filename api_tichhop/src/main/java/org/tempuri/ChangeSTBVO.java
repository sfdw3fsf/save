...
/**
 *  ChangeSTBVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSTBVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSTBVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSTBVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeSTBVO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            ChangeSTBVO object = new ChangeSTBVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSTBVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSTBVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
