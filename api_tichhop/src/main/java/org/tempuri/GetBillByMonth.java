...
/**
 *  GetBillByMonth bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetBillByMonth implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetBillByMonth", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetBillByMonth", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetBillByMonth parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetBillByMonth object = new GetBillByMonth();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetBillByMonth".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetBillByMonth) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
