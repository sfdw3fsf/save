...
/**
 *  UpdatePromotions bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdatePromotions implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "UpdatePromotions", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":UpdatePromotions", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "UpdatePromotions", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdatePromotions parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdatePromotions object = new UpdatePromotions();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdatePromotions".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdatePromotions) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
