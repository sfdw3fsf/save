...
/**
 *  B2B_HotelAddOnDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class B2B_HotelAddOnDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = B2B_HotelAddOnDTO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":B2B_HotelAddOnDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "B2B_HotelAddOnDTO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static B2B_HotelAddOnDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            B2B_HotelAddOnDTO object = new B2B_HotelAddOnDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"B2B_HotelAddOnDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (B2B_HotelAddOnDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
