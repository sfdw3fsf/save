...
/**
 *  GetPackageNameVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetPackageNameVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = GetPackageNameVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetPackageNameVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetPackageNameVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetPackageNameVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPackageNameVO object = new GetPackageNameVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetPackageNameVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetPackageNameVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
