...
/**
 *  Smart_OTTGetMemberPendingVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Smart_OTTGetMemberPendingVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Smart_OTTGetMemberPendingVO
     ...
     * field for Data
     */
    protected org.tempuri.ArrayOfOTTGetMemberPendingResult localData;
    ...
    /**
     * Auto generated getter method
     * @return org.tempuri.ArrayOfOTTGetMemberPendingResult
     */
    public org.tempuri.ArrayOfOTTGetMemberPendingResult getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(org.tempuri.ArrayOfOTTGetMemberPendingResult param) {
    ...
    public int getTotalItem() {
        return localTotalItem;
    }

    /**
     * Auto generated setter method
     * @param param TotalItem
     */
    public void setTotalItem(int param) {
        this.localTotalItem = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Smart_OTTGetMemberPendingVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Smart_OTTGetMemberPendingVO", xmlWriter);
            }
        }
        ...
        namespace = "http://tempuri.org/";
        writeStartElement(null, namespace, "totalItem", xmlWriter);

        if (localTotalItem == java.lang.Integer.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
                "totalItem cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localTotalItem));
        }
    ...
    public static class Factory {
         ...
         */
        public static Smart_OTTGetMemberPendingVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Smart_OTTGetMemberPendingVO object = new Smart_OTTGetMemberPendingVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Smart_OTTGetMemberPendingVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Smart_OTTGetMemberPendingVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setData(org.tempuri.ArrayOfOTTGetMemberPendingResult.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "totalItem").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "totalItem" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setTotalItem(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
