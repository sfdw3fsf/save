...
/**
 *  ChangePasswordVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePasswordVO implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePasswordVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePasswordVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangePasswordVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePasswordVO object = new ChangePasswordVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePasswordVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePasswordVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
