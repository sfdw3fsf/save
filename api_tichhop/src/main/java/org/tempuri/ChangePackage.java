...
/**
 *  ChangePackage bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePackage implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePackage", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePackage", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangePackage parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePackage object = new ChangePackage();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePackage".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePackage) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
