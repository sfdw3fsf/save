...
/**
 *  ChangePackageHstDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangePackageHstDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangePackageHstDTO
     ...
     */
    protected java.lang.String localOperator_type;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localOperator_typeTracker = false;
    ...
    /**
     * field for Payment_channel
     */
    protected java.lang.String localPayment_channel;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localPayment_channelTracker = false;

    /**
     * field for Bill_number
     */
    protected java.lang.String localBill_number;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localBill_numberTracker = false;
    ...
    public boolean isOperator_typeSpecified() {
        return localOperator_typeTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getOperator_type() {
     ...
     */
    public void setOperator_type(java.lang.String param) {
        localOperator_typeTracker = param != null;
    ...
    public boolean isPayment_channelSpecified() {
        return localPayment_channelTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getPayment_channel() {
        return localPayment_channel;
    }

    /**
     * Auto generated setter method
     * @param param Payment_channel
     */
    public void setPayment_channel(java.lang.String param) {
        localPayment_channelTracker = param != null;

        this.localPayment_channel = param;
    }

    public boolean isBill_numberSpecified() {
        return localBill_numberTracker;
    }
    ...
    public java.lang.String getBill_number() {
        return localBill_number;
    }

    /**
     * Auto generated setter method
     * @param param Bill_number
     */
    public void setBill_number(java.lang.String param) {
        localBill_numberTracker = param != null;

        this.localBill_number = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangePackageHstDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangePackageHstDTO", xmlWriter);
            }
        }
        ...
        if (localOperator_typeTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "operator_type", xmlWriter);

            if (localOperator_type == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "operator_type cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localOperator_type);
            }
        ...
        if (localPayment_channelTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "payment_channel", xmlWriter);

            if (localPayment_channel == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "payment_channel cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localPayment_channel);
            }

            xmlWriter.writeEndElement();
        }

        if (localBill_numberTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "bill_number", xmlWriter);

            if (localBill_number == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "bill_number cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localBill_number);
            }
    ...
    public static class Factory {
         ...
         */
        public static ChangePackageHstDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangePackageHstDTO object = new ChangePackageHstDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangePackageHstDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangePackageHstDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "operator_type").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "operator_type" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setOperator_type(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "product_type").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "payment_channel").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "payment_channel" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setPayment_channel(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "bill_number").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "bill_number" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setBill_number(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "voucher_id").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "voucher_id" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setVoucher_id(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
