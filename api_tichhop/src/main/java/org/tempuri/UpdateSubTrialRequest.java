...
/**
 *  UpdateSubTrialRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateSubTrialRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = UpdateSubTrialRequest
     ...
     * field for CodeID
     */
    protected java.lang.String localCodeID;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCodeIDTracker = false;
    ...
    public boolean isCodeIDSpecified() {
        return localCodeIDTracker;
    }
     ...
     * @param param CodeID
     */
    public void setCodeID(java.lang.String param) {
        localCodeIDTracker = param != null;

        this.localCodeID = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":UpdateSubTrialRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "UpdateSubTrialRequest", xmlWriter);
            }
        }
        ...
        if (localCodeIDTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "CodeID", xmlWriter);

            if (localCodeID == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "CodeID cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localCodeID);
            }
    ...
    public static class Factory {
         ...
         */
        public static UpdateSubTrialRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateSubTrialRequest object = new UpdateSubTrialRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdateSubTrialRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateSubTrialRequest) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "CodeID" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setCodeID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
