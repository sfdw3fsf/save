...
/**
 *  GetPackageEPGVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetPackageEPGVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = GetPackageEPGVO
     ...
     * field for GetData
     */
    protected org.tempuri.GetData_type1 localGetData;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localGetDataTracker = false;
    ...
    public boolean isGetDataSpecified() {
        return localGetDataTracker;
    }

    /**
     * Auto generated getter method
     * @return org.tempuri.GetData_type1
     */
    public org.tempuri.GetData_type1 getGetData() {
        return localGetData;
    }
     ...
     * @param param GetData
     */
    public void setGetData(org.tempuri.GetData_type1 param) {
        localGetDataTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetPackageEPGVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetPackageEPGVO", xmlWriter);
            }
        }
        ...
        if (localGetDataTracker) {
            if (localGetData == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "GetData cannot be null!!");
            }

            localGetData.serialize(new javax.xml.namespace.QName(
                    "http://tempuri.org/", "GetData"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static GetPackageEPGVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPackageEPGVO object = new GetPackageEPGVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetPackageEPGVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetPackageEPGVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "GetData").equals(reader.getName())) {
                    object.setGetData(org.tempuri.GetData_type1.Factory.parse(
                            reader));
