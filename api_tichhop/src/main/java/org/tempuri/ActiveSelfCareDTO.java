...
/**
 *  ActiveSelfCareDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ActiveSelfCareDTO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ActiveSelfCareDTO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ActiveSelfCareDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ActiveSelfCareDTO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ActiveSelfCareDTO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ActiveSelfCareDTO object = new ActiveSelfCareDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ActiveSelfCareDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ActiveSelfCareDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
