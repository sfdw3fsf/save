...
/**
 *  Smart_OTTGetMemberPendingRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Smart_OTTGetMemberPendingRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Smart_OTTGetMemberPendingRequest
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Smart_OTTGetMemberPendingRequest",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Smart_OTTGetMemberPendingRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Smart_OTTGetMemberPendingRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Smart_OTTGetMemberPendingRequest object = new Smart_OTTGetMemberPendingRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Smart_OTTGetMemberPendingRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Smart_OTTGetMemberPendingRequest) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
