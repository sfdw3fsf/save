...
/**
 *  GetSubscriberBySTB_SN bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetSubscriberBySTB_SN implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "GetSubscriberBySTB_SN", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetSubscriberBySTB_SN", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetSubscriberBySTB_SN", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetSubscriberBySTB_SN parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetSubscriberBySTB_SN object = new GetSubscriberBySTB_SN();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetSubscriberBySTB_SN".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetSubscriberBySTB_SN) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
