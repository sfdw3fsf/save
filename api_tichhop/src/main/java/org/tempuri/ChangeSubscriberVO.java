...
/**
 *  ChangeSubscriberVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ChangeSubscriberVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ChangeSubscriberVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ChangeSubscriberVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ChangeSubscriberVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ChangeSubscriberVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ChangeSubscriberVO object = new ChangeSubscriberVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ChangeSubscriberVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ChangeSubscriberVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
