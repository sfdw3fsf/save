...
/**
 *  DataHBO_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DataHBO_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DataHBO_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DataHBO_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DataHBO_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DataHBO_type0 object = new DataHBO_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DataHBO_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DataHBO_type0) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
