...
/**
 *  GetUserParent bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetUserParent implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetUserParent", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetUserParent", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetUserParent parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetUserParent object = new GetUserParent();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetUserParent".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetUserParent) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
