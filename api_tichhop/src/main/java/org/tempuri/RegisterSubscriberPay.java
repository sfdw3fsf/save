...
/**
 *  RegisterSubscriberPay bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterSubscriberPay implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "RegisterSubscriberPay", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RegisterSubscriberPay", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RegisterSubscriberPay", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegisterSubscriberPay parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterSubscriberPay object = new RegisterSubscriberPay();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegisterSubscriberPay".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterSubscriberPay) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
