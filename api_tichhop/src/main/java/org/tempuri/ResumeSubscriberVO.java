...
/**
 *  ResumeSubscriberVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ResumeSubscriberVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ResumeSubscriberVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ResumeSubscriberVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ResumeSubscriberVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ResumeSubscriberVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ResumeSubscriberVO object = new ResumeSubscriberVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResumeSubscriberVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ResumeSubscriberVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
