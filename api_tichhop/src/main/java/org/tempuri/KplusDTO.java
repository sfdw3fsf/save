...
public class KplusDTO implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected int localMETHOD_FLG;

    /**
     * field for SUBPACK
     */
    protected java.lang.String localSUBPACK;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSUBPACKTracker = false;
     ...
     */
    public void setMETHOD_FLG(int param) {
        this.localMETHOD_FLG = param;
    }

    public boolean isSUBPACKSpecified() {
        return localSUBPACKTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getSUBPACK() {
        return localSUBPACK;
    }
     ...
     * @param param SUBPACK
     */
    public void setSUBPACK(java.lang.String param) {
        localSUBPACKTracker = param != null;

        this.localSUBPACK = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":KplusDTO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "KplusDTO", xmlWriter);
        ...
        if (localMETHOD_FLG == java.lang.Integer.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
        ...
        if (localSUBPACKTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "SUBPACK", xmlWriter);

            if (localSUBPACK == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "SUBPACK cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localSUBPACK);
            }
    ...
    public static class Factory {
         ...
         */
        public static KplusDTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            KplusDTO object = new KplusDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"KplusDTO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (KplusDTO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setMETHOD_FLG(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "SUBPACK" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSUBPACK(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
