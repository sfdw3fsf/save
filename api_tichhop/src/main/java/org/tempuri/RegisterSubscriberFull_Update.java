...
/**
 *  RegisterSubscriberFull_Update bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterSubscriberFull_Update implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "RegisterSubscriberFull_Update", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RegisterSubscriberFull_Update",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RegisterSubscriberFull_Update", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegisterSubscriberFull_Update parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterSubscriberFull_Update object = new RegisterSubscriberFull_Update();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegisterSubscriberFull_Update".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterSubscriberFull_Update) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
