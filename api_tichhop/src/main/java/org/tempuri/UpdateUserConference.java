...
/**
 *  UpdateUserConference bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UpdateUserConference implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "UpdateUserConference", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":UpdateUserConference", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "UpdateUserConference", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateUserConference parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateUserConference object = new UpdateUserConference();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdateUserConference".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UpdateUserConference) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
