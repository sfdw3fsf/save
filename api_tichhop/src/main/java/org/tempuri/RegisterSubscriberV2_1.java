...
/**
 *  RegisterSubscriberV2_1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterSubscriberV2_1 implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "RegisterSubscriberV2_1", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RegisterSubscriberV2_1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RegisterSubscriberV2_1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegisterSubscriberV2_1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterSubscriberV2_1 object = new RegisterSubscriberV2_1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegisterSubscriberV2_1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterSubscriberV2_1) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
