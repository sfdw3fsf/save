...
/**
 *  SuspendSubscriberVO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SuspendSubscriberVO implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = SuspendSubscriberVO
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SuspendSubscriberVO", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SuspendSubscriberVO", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SuspendSubscriberVO parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SuspendSubscriberVO object = new SuspendSubscriberVO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SuspendSubscriberVO".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SuspendSubscriberVO) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
