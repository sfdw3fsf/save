...
/**
 *  GetSubscriberInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetSubscriberInfo implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "GetSubscriberInfo", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetSubscriberInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetSubscriberInfo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetSubscriberInfo parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetSubscriberInfo object = new GetSubscriberInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetSubscriberInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetSubscriberInfo) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
