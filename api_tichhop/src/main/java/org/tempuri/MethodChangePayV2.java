...
/**
 *  MethodChangePayV2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MethodChangePayV2 implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "MethodChangePayV2", "ns1");
    ...
    /**
     * field for SStartDate
     */
    protected java.lang.String localSStartDate;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSStartDateTracker = false;
    ...
    public boolean isSStartDateSpecified() {
        return localSStartDateTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getSStartDate() {
        return localSStartDate;
    }

    /**
     * Auto generated setter method
     * @param param SStartDate
     */
    public void setSStartDate(java.lang.String param) {
        localSStartDateTracker = param != null;

        this.localSStartDate = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MethodChangePayV2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MethodChangePayV2", xmlWriter);
            }
        }
        ...
        if (localSStartDateTracker) {
            namespace = "http://tempuri.org/";
            writeStartElement(null, namespace, "sStartDate", xmlWriter);

            if (localSStartDate == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "sStartDate cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localSStartDate);
            }
    ...
    public static class Factory {
         ...
         */
        public static MethodChangePayV2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MethodChangePayV2 object = new MethodChangePayV2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MethodChangePayV2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MethodChangePayV2) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "sStartDate").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "sStartDate" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSStartDate(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
