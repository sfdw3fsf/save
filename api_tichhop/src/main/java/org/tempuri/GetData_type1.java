...
/**
 *  GetData_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetData_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetData_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetData_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetData_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetData_type1 object = new GetData_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetData_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetData_type1) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
