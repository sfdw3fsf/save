...
public class AddNewDistrict  implements java.io.Serializable {
    ...
    /**
     * Gets the districtName value for this AddNewDistrict.
     * 
     * @return districtName
     */
    ...
    /**
     * Sets the districtName value for this AddNewDistrict.
     * 
     * @param districtName
     */
    ...
    /**
     * Gets the provinceCD value for this AddNewDistrict.
     * 
     * @return provinceCD
     */
    ...
    /**
     * Sets the provinceCD value for this AddNewDistrict.
     * 
     * @param provinceCD
     */
    ...
    /**
     * Gets the districtCD value for this AddNewDistrict.
     * 
     * @return districtCD
     */
    ...
    /**
     * Sets the districtCD value for this AddNewDistrict.
     * 
     * @param districtCD
     */
    ...
    /**
     * Gets the districtNote value for this AddNewDistrict.
     * 
     * @return districtNote
     */
    ...
    /**
     * Sets the districtNote value for this AddNewDistrict.
     * 
     * @param districtNote
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof AddNewDistrict)) return false;
        AddNewDistrict other = (AddNewDistrict) obj;
        ...
        _equals = true && 
            ...
            ((this.provinceCD==null && other.getProvinceCD()==null) || 
             (this.provinceCD!=null &&
              this.provinceCD.equals(other.getProvinceCD()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getProvinceCD() != null) {
            _hashCode += getProvinceCD().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddNewDistrict.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">AddNewDistrict"));
        ...
        elemField.setFieldName("provinceCD");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "ProvinceCD"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
