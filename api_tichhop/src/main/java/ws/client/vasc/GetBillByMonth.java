...
public class GetBillByMonth  implements java.io.Serializable {
    private String IPTVAccount;

    private String month;

    public GetBillByMonth() {
    }
    ...
    /**
     * Gets the IPTVAccount value for this GetBillByMonth.
     * 
     * @return IPTVAccount
     */
    ...
    /**
     * Sets the IPTVAccount value for this GetBillByMonth.
     * 
     * @param IPTVAccount
     */
    ...
    /**
     * Gets the month value for this GetBillByMonth.
     * 
     * @return month
     */
    ...
    /**
     * Sets the month value for this GetBillByMonth.
     * 
     * @param month
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetBillByMonth)) return false;
        GetBillByMonth other = (GetBillByMonth) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetBillByMonth.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetBillByMonth"));
