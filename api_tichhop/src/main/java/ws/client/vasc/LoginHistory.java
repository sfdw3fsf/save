...
public class LoginHistory  implements java.io.Serializable {
    ...
    /**
     * Gets the username value for this LoginHistory.
     * 
     * @return username
     */
    ...
    /**
     * Sets the username value for this LoginHistory.
     * 
     * @param username
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">LoginHistory"));
