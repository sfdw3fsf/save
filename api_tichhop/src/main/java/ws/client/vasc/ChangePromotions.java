...
public class ChangePromotions  implements java.io.Serializable {
    private String IPTVACCOUNT;

    private String sPromo_ID;

    public ChangePromotions() {
    }
    ...
    /**
     * Gets the IPTVACCOUNT value for this ChangePromotions.
     * 
     * @return IPTVACCOUNT
     */
    ...
    /**
     * Sets the IPTVACCOUNT value for this ChangePromotions.
     * 
     * @param IPTVACCOUNT
     */
    ...
    /**
     * Gets the sPromo_ID value for this ChangePromotions.
     * 
     * @return sPromo_ID
     */
    ...
    /**
     * Sets the sPromo_ID value for this ChangePromotions.
     * 
     * @param sPromo_ID
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ChangePromotions)) return false;
        ChangePromotions other = (ChangePromotions) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangePromotions.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">ChangePromotions"));
