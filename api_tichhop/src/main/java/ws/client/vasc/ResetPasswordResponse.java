...
public class ResetPasswordResponse  implements java.io.Serializable {
    private ResetPasswordVO resetPasswordResult;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           ResetPasswordVO resetPasswordResult) {
     ...
     */
    public ResetPasswordVO getResetPasswordResult() {
        return resetPasswordResult;
    }
     ...
     */
    public void setResetPasswordResult(ResetPasswordVO resetPasswordResult) {
        this.resetPasswordResult = resetPasswordResult;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "ResetPasswordVO"));
