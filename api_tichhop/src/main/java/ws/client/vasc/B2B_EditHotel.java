...
public class B2B_EditHotel  implements java.io.Serializable {
    private B2B_HotelDTO hotelDTO;

    public B2B_EditHotel() {
    }
    ...
    /**
     * Gets the hotelDTO value for this B2B_EditHotel.
     * 
     * @return hotelDTO
     */
    ...
    /**
     * Sets the hotelDTO value for this B2B_EditHotel.
     * 
     * @param hotelDTO
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof B2B_EditHotel)) return false;
        B2B_EditHotel other = (B2B_EditHotel) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(B2B_EditHotel.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">B2B_EditHotel"));
