...
public class ResetPassword  implements java.io.Serializable {
    ...
    /**
     * Gets the IPTVAccount value for this ResetPassword.
     * 
     * @return IPTVAccount
     */
    ...
    /**
     * Sets the IPTVAccount value for this ResetPassword.
     * 
     * @param IPTVAccount
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">ResetPassword"));
