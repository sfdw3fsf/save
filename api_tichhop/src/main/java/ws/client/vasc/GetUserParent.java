...
public class GetUserParent  implements java.io.Serializable {
    private String iptvAccount;

    public GetUserParent() {
    }
    ...
    /**
     * Gets the iptvAccount value for this GetUserParent.
     * 
     * @return iptvAccount
     */
    ...
    /**
     * Sets the iptvAccount value for this GetUserParent.
     * 
     * @param iptvAccount
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetUserParent)) return false;
        GetUserParent other = (GetUserParent) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetUserParent.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetUserParent"));
