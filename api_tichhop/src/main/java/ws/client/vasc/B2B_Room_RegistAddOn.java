...
public class B2B_Room_RegistAddOn  implements java.io.Serializable {
    private B2B_RoomAddOnDTO rAddOnDTO;

    public B2B_Room_RegistAddOn() {
    }
    ...
    /**
     * Gets the rAddOnDTO value for this B2B_Room_RegistAddOn.
     * 
     * @return rAddOnDTO
     */
    ...
    /**
     * Sets the rAddOnDTO value for this B2B_Room_RegistAddOn.
     * 
     * @param rAddOnDTO
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof B2B_Room_RegistAddOn)) return false;
        B2B_Room_RegistAddOn other = (B2B_Room_RegistAddOn) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(B2B_Room_RegistAddOn.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">B2B_Room_RegistAddOn"));
