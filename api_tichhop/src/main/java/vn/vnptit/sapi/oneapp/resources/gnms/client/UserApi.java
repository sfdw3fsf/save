...
public class UserApi {
     ...
     * @param accConfig The accConfig parameter
     * @return BaseResponse
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseResponse> userConfigNewPassWord(AccConfig accConfig) throws WebClientResponseException {
        Object postBody = accConfig;
        ...
        return apiClient.invokeAPI("/user/configNewPassWord", HttpMethod.POST, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
