...
public class DeviceParamResponse   {
  @JsonProperty("data")
  ...
  public DeviceParamResponse data(DeviceParam data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public DeviceParamResponse errorCode(String errorCode) {
  ...
  */
  ...
  public DeviceParamResponse message(String message) {
  ...
  */
  ...
  public DeviceParamResponse result(String result) {
    this.result = result;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DeviceParamResponse deviceParamResponse = (DeviceParamResponse) o;
    return Objects.equals(this.data, deviceParamResponse.data) &&
        Objects.equals(this.errorCode, deviceParamResponse.errorCode) &&
        Objects.equals(this.message, deviceParamResponse.message) &&
        Objects.equals(this.result, deviceParamResponse.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceParamResponse {\n");
