...
public class PingResultResponse   {
  ...
  public PingResultResponse data(PingResult data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public PingResult getData() {
    return data;
  }

  public void setData(PingResult data) {
    this.data = data;
  }

  public PingResultResponse errorCode(String errorCode) {
  ...
  */
  ...
  public PingResultResponse message(String message) {
  ...
  */
  ...
  public PingResultResponse result(String result) {
    this.result = result;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PingResultResponse pingResultResponse = (PingResultResponse) o;
    return Objects.equals(this.data, pingResultResponse.data) &&
        Objects.equals(this.errorCode, pingResultResponse.errorCode) &&
        Objects.equals(this.message, pingResultResponse.message) &&
        Objects.equals(this.result, pingResultResponse.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class PingResultResponse {\n");
