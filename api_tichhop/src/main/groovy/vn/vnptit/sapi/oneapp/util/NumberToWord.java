...
public class NumberToWord {
    ...
    public static void main(String[] args) {
        System.out.println(NumberToWord.num2String(2436873).substring(0,1).toUpperCase() + NumberToWord.num2String(2436873).substring(1) + " đồng");
    }
}