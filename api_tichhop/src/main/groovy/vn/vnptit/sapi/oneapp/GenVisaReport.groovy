...
class GenVisaReport {
    static void main(String[] args) {
        ...
        actions.each { action ->
            ...
            new File(System.getProperty("user.dir") + "/src/main/groovy/vn/vnptit/sapi/oneapp/models/visareport/${actionName}.groovy").newWriter().withWriter { w ->
                w.append("""package vn.vnptit.sapi.oneapp.models.visareport
