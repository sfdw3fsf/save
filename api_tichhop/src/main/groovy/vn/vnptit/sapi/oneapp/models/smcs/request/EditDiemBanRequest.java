...
public class EditDiemBanRequest {
    ...
    @SerializedName("agentCodeOld")
    @Expose
    private String agentCodeOld;
    @SerializedName("agentCodeNew")
    @Expose
    ...
    public String getAgentCodeOld() {
        return agentCodeOld;
    }

    public void setAgentCodeOld(String agentCodeOld) {
        this.agentCodeOld = agentCodeOld;
    }
