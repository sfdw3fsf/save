    ...
    this.axios.interceptors.request.use(
      async (config: AxiosRequestConfig): Promise<any> => {
        ...
        config.headers = {
          'branch-id': '84',
          Authorization:
            'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI1MiIsImlhdCI6MTczMzM2MjMwMywiZXhwIjoxNzM1OTU0MzAzfQ.y_EmZusdBIJNCIQNRTcdDbFRiigRQx6WJFqr8MLqqqc',
          ...config.headers,
        };
