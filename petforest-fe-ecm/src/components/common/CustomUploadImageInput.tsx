...
const CustomImageUploadInput = ({ value, multiple = false, disabled, onChange, fileType, maxCount }: CustomFileUploadProps) => {
  ...
  const uploadButton = (
    <button style={{ border: 0, background: 'none' }} type='button'>
      <img className=' h-full w-full' src='/images/camera.png' alt='camera' />
    </button>
  );
