...
@Schema
public class INSERT_HOSO_ITCARE_SMPRequest {
    @JsonProperty("vloaifile_id")
    private Integer vloaifile_id;

    @JsonProperty("vdb_id")
    private Integer vdb_id;

    @JsonProperty("vloaidb_id")
    private Integer vloaidb_id;

    @JsonProperty("vfile_name")
    private String vfile_name;

    @JsonProperty("vfile_url")
    private String vfile_url;
