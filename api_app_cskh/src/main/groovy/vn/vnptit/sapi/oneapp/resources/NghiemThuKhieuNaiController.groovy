...
import io.swagger.api.NghiemThuKhieuNaiApi
...
@RestController
class NghiemThuKhieuNaiController implements NghiemThuKhieuNaiApi {
    ...
    @Autowired
    NghiemThuKhieuNaiController(ObjectMapper objectMapper, HttpServletRequest request) {
    ...
    ResponseEntity<BaseResponse<List<TBKhieuNaiXL>>> dsTBKhieuNaiXL(Integer trangThai, Integer toTruong) {
        ...
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsTBKhieuNaiXL] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
                ...
                sql.call(sqlString, [Long.parseLong(phanVungId), Long.parseLong(donViId), Long.parseLong(nhanVienId), "5", "2253", "", 0, trangThai, toTruong, CURSOR_PARAMETER]) { ResultSet rs ->
                    while (rs.next()) {
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsTBKhieuNaiXL] - Response: ",
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsTBKhieuNaiXL] - Error:", e)
    ...
    ResponseEntity<BaseResponse<Integer>> toTruong() {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [toTruong] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [toTruong] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [toTruong] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DanhMuc>>> dsKieuHienThi() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKieuHienThi] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKieuHienThi] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsKieuHienThi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DanhMuc>>> dsKQXL() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKQXL] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKQXL] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsKQXL] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<NhanVienXLKN>>> dsNhanVienTH() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNhanVienTH] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            String nhanVienId = session_.get(ID_NHANVIEN_DHSX)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNhanVienTH] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsNhanVienTH] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DanhMuc>>> dsPhuongAnXL() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhuongAnXL] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhuongAnXL] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsPhuongAnXL] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<KetQuaLoi>>> dsKQLoi() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKQLoi] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKQLoi] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsKQLoi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DanhMuc>>> dsMucDoHL() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsMucDoHL] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsMucDoHL] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsMucDoHL] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DanhMuc>>> dsKieuTra() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKieuTra] - Request: ", new ImmutableMap.Builder<String, Object>().put("request_id", requestId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            Sql.newInstance(oracleManaged.getDataSource(dataSrc)).withCloseable { sql ->
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKieuTra] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsKieuTra] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<NVChiuTrachNhiemXLKN>>> dsNVChiuTrachNhiem(Long khieuNaiId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNVChiuTrachNhiem] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNVChiuTrachNhiem] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsNVChiuTrachNhiem] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<NVDangChiuLoi>>> dsNVDangChiuLoi(Long khieuNaiId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNVDangChiuLoi] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("khieuNaiId", khieuNaiId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsNVDangChiuLoi] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsNVDangChiuLoi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> cnNhanVienLoi(CNNhanVienLoiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnNhanVienLoi] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnNhanVienLoi] - Response: ",
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [cnNhanVienLoi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DVChiuTrachNhiemXLKN>>> dsDVChiuTrachNhiem(Long khieuNaiId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDVChiuTrachNhiem] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("khieuNaiId", khieuNaiId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDVChiuTrachNhiem] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsDVChiuTrachNhiem] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DVDangChiuLoi>>> dsDVDangChiuLoi(Long khieuNaiId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDVDangChiuLoi] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("khieuNaiId", khieuNaiId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDVDangChiuLoi] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsDVDangChiuLoi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> cnDonViLoi(CNDonViLoiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnDonViLoi] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnDonViLoi] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (mess != null && mess == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [cnDonViLoi] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<ThueBaoChenNo>>> dsTBChenNo(String kyHD, String maTT) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsTBChenNo] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsTBChenNo] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsTBChenNo] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<String>>> dsChuKy(String kyHD) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsChuKy] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsChuKy] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsChuKy] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<ThongTinGiamCuoc>>> dsGiamCuoc(Long khieuNaiId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsGiamCuoc] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("khieuNaiId", khieuNaiId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsGiamCuoc] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsGiamCuoc] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> cnChenNo(CNChenNoRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnChenNo] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnChenNo] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (mess != null && mess == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [cnChenNo] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> hoanThienHSKN(HoanThienHSKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [hoanThienHSKN] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [hoanThienHSKN] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [hoanThienHSKN] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> khoaPhieu(KhoaPhieuKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [khoaPhieu] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [khoaPhieu] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [khoaPhieu] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<PhieuKN>>> dsPhieuKN(String maTB) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhieuKN] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhieuKN] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsPhieuKN] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> giaoViec(GiaoViecXLKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [giaoViec] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [giaoViec] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [giaoViec] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> traPhieu(TraPhieuKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [traPhieu] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [traPhieu] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [traPhieu] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<HuongGiaoPhieuKN>>> dsHuongGiao(Long quyTrinhId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsHuongGiao] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsHuongGiao] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsHuongGiao] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<DVGiaoPhieuKN>>> dsDonViGiao(Long huongGiaoId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDonViGiao] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsDonViGiao] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsDonViGiao] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<PhieuDaGiaoKN>>> dsPhieuDaGiao(Long phieuKNId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhieuDaGiao] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsPhieuDaGiao] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsPhieuDaGiao] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> giaoPhieuPH(GiaoPhieuPHKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [giaoPhieuPH] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [giaoPhieuPH] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
                if (smsList != null && smsList.size() > 0) {
                    String token = session_.get(TOKEN)
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [giaoPhieuPH] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<HoSoKN>>> dsHoSoKN(Long khieuNaiId, String kyHD) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsHoSoKN] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsHoSoKN] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsHoSoKN] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> cnHoSoKN(CNHoSoKhieuNaiRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnHoSoKN] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [cnHoSoKN] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", mess != null ? mess : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [cnHoSoKN] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> xoaHoSoKN(Long hoSoKNId) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [xoaHoSoKN] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [xoaHoSoKN] - Response: ",
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [xoaHoSoKN] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<GiaoViecNV>>> dsGiaoViecNV(Long phieuKNId) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsGiaoViecNV] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("phieuKNId", phieuKNId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsGiaoViecNV] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsGiaoViecNV] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> xoaGiaoViecNV(XoaGiaoViecNVRequest requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [xoaGiaoViecNV] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [xoaGiaoViecNV] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", kq != null ? kq : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [xoaGiaoViecNV] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<ThangGC>>> dsThangGC(String maTT, String maTB) {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsThangGC] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsThangGC] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsThangGC] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<List<KyApGC>>> dsKyApGC() {
        ...
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKyApGC] - Request: ", new ImmutableMap.Builder<String, Object>()
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [dsKyApGC] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", ret != null && ret.size() > 0 ? ret.toString() : "").build())
            return ResponseEntity.ok().body(BaseResponseBuilder.of(ret))
        } catch (Exception e) {
            loggingManaged.error("[NghiemThuKhieuNaiController] - [dsKyApGC] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }

    @Override
    ResponseEntity<BaseResponse<Void>> chuyenNetMedia(ChuyenNetMediaXLKN requestBody) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [chuyenNetMedia] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("requestBody", requestBody).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [chuyenNetMedia] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", kq != null ? kq : "").build())
            if (kq != null && kq == 'OK') {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [chuyenNetMedia] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> huyGiaoViec(Long phieuKNId) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoViec] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("phieuKNId", phieuKNId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoViec] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", kq != null ? kq : "").build())
            if (kq != null && kq == 'OK') {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [huyGiaoViec] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> huyGiaoPhieu(Long phieuKNId) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoPhieu] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("phieuKNId", phieuKNId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoPhieu] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", kq != null ? kq : "").build())
            if (kq != null && kq == 'OK') {
                return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, MessageUtils.SUCCESS, ErrorCodeDefine.SUCCESS))
            } else {
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [huyGiaoPhieu] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
    ...
    ResponseEntity<BaseResponse<Void>> huyGiaoPhieuPH(Long phieuKNId) {
        String requestId = genericApi.generateRequestId()
        try {
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoPhieuPH] - Request: ", new ImmutableMap.Builder<String, Object>()
                    .put("request_id", requestId).put("phieuKNId", phieuKNId).build())
            Map<String, Object> session_ = genericApi.getSessionData(request)
            String dataSrc = session_.get(CSS_SCH)
            String phanVungId = session_.get(ID_TINHTHANH)
            ...
            loggingManaged.info("[NghiemThuKhieuNaiController] - [huyGiaoPhieuPH] - Response: ",
                    new ImmutableMap.Builder<String, Object>().put("result", kq != null ? kq : "").build())
            if (kq != null && kq == 'OK') {
                Sql.newInstance(oracleManaged.getDataSource("css_khdn")).withCloseable { sql ->
            ...
            loggingManaged.error("[NghiemThuKhieuNaiController] - [huyGiaoPhieuPH] - Error:", e)
            return ResponseEntity.ok().body(BaseResponseBuilder.of(null, requestId, e.message, ErrorCodeDefine.INTERNAL_SERVER_ERROR))
        }
    }
}
