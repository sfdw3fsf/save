...
@Schema
public class TBKhieuNaiXL extends BaseDTO {
    ...
    @JsonProperty("nhanVienGiao")
    private String nhanVienGiao = null;
    @JsonProperty("donViGiao")
    private String donViGiao = null;
    @JsonProperty("donViNhan")
    private String donViNhan = null;
    @JsonProperty("tuyenThu")
    private String tuyenThu = null;
    @JsonProperty("ketQua")
    private String ketQua = null;
    @JsonProperty("ngayGQ")
    private String ngayGQ = null;
    @JsonProperty("nvThucHien")
    private String nvThucHien = null;
    @JsonProperty("paXLKN")
    private String paXLKN = null;
    @JsonProperty("ketQuaKN")
    private String ketQuaKN = null;
    ...
    public String getPaXLKN() {
        return paXLKN;
    }

    public void setPaXLKN(String paXLKN) {
        this.paXLKN = paXLKN;
    }

    public String getKetQuaKN() {
        return ketQuaKN;
    }

    public void setKetQuaKN(String ketQuaKN) {
        this.ketQuaKN = ketQuaKN;
    }
    ...
    public String getTuyenThu() {
        return tuyenThu;
    }

    public void setTuyenThu(String tuyenThu) {
        this.tuyenThu = tuyenThu;
    }
