...
@Schema
public class LayDSPhieuCapNhatKQXLRequest extends PageRequest {
    ...
    @JsonProperty("mucDoKcId")
    private Long mucDoKcId = null;
    ...
    @JsonProperty("ngayGiaoTu")
    private String ngayGiaoTu = null;
    @JsonProperty("ngayGiaoDen")
    private String ngayGiaoDen = null;
    ...
    public Long getMucDoKcId() {
        return mucDoKcId;
    }

    public void setMucDoKcId(Long mucDoKcId) {
        this.mucDoKcId = mucDoKcId;
    }
    ...
    public String getNgayGiaoTu() {
        return ngayGiaoTu;
    }

    public void setNgayGiaoTu(String ngayGiaoTu) {
        this.ngayGiaoTu = ngayGiaoTu;
    }
