...
import { userCalendarExpertAPI } from '@/data/user/user.api';
...
const ScheduleExpertPage = (): JSX.Element => {
  ...
  const {
    ...
    queryFn: () => userCalendarExpertAPI(request!),
...
export default ScheduleExpertPage;
