...
export type FormMessageTranslateKey = Path<(typeof i18nResources)['en']['form']>;
...
const FormMessage = ({ variant = 'info', message, translateKey, truncate = false, className }: FormMessageProps): JSX.Element => {
  ...
  return (
    <div className={twMerge('flex w-full items-start justify-start gap-1', variantColor, className)}>
      {!!variantIcon && (
