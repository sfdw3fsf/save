  ...
  return (
    <div className='relative flex max-w-[1376px] items-center justify-center overflow-hidden'>
      ...
      <div className='absolute inset-0 flex flex-col items-center justify-center gap-3'>
        <h1 className='max-w-[768px] text-center text-4xl font-bold text-warm-950 max-md:text-2xl'>{t("overview_tittle")}</h1>
        <p className='text-center text-lg font-normal text-warm-600 max-md:text-base'>{t("overview_content")}</p>
      </div>
    </div>
  );
}

export default OverviewTestSection;
