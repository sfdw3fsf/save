                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="thietbi_ims_selected" disabled class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            <div class="key w80">Thiết bị IMS</div>
                            <div class="value">
                                <div class="select-custom" ref="ds_thietbi_ims">
                                    <select2 :settings="{ dropdownParent: $refs['ds_thietbi_ims'] }" ref="cboThietBiIms"
                                        v-model="thietbi_ims_moi_selected" class="select2"
                                        :options="ds_thietbi_ims.map(e=> ({id: e.thietbi_id, text: e.ten_tbi}))">
                                    </select2>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom" ref="ds_chitiet_dv">
                                    <select2 :settings="{ dropdownParent: $refs['ds_chitiet_dv'] }" ref="cboChiTietDV"
                                        v-model="chitiet_dv_selected" class="select2"
                                        :options="ds_chitiet_dv.map(e=> ({id: e.ctdv_id, text: e.chitiet_dv}))">
                                    </select2>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods:{
        ...
        async HienThiTTMoRong_HD(item){
            ...
            this.thietbi_ims_moi_selected=item.thietbi_id?item.thietbi_id:null
            this.input_matn=item.matb_tn?item.matb_tn.toString():''
            this.input_sl_cuocgoi=item.sl_cuocgoi?item.sl_cuocgoi.toString():''
            this.input_ip=item.ip?item.ip.toString():''
        ...
        async initDuLieu(ds_loaihinh_tb){
            ...
            // this.ds_loaihinh=ds_loaihinh_tb.filter(x=>(x.DICHVUVT_ID==11&&x.SUDUNG==1))
