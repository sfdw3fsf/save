    ...
    return {
      ...
      grcDanhBaTBI : {
        ...
        header : [
           ...
           // {fieldName: 'IP_LAN', headerText: 'Ngoại mạng Mobifone', allowFiltering: true, width : 'auto'},
            //{fieldName: 'IP_WAN', headerText: 'Ngoại mạng Viettel', allowFiltering: true, width : 'auto', },
