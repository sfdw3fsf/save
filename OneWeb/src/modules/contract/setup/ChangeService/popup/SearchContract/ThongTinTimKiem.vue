          ...
          <div class="value">
            <div class="select-custom">
              <!-- <div class="info-row">
                <div class="select-custom">
                  <vue-select
                    v-model="loai_hd_selected"
                    :labelWidth="'110'"
                    :options="danhsach_loaihd"
                    labelField="NAME"
                    valueField="ID"
                    @input="changeKieuYeuCau"
                    :disabled="!checkBoxs.loai_hd"
                  ></vue-select>
                </div>
              </div> -->
          ...
          <div class="value">
            <div class="select-custom">
              <select
                ...
                :disabled="!checkBoxs.dichvu"
                class="form-control"
              >
                <option
                  v-for="item in danhsach_dv"
                  :key="item.ID"
                  :value="item.ID"
                  >{{ item.NAME }}</option
                >
        ...
        <div class="info-row">
          <div class="key w140">
            <div class="check-action">
              <input
                type="checkbox"
                v-model="checkBoxs.trangthai_hd"
                class="check"
              />
          ...
          <div class="value">
            <div class="select-custom">
              <select
                v-model="trangthai_hd_selected"
                :disabled="!checkBoxs.trangthai_hd"
                class="form-control"
              >
                <option
                  v-for="item in danhsach_trangthai_hd"
                  :key="item.ID"
                  :value="item.ID"
                  >{{ item.NAME }}</option
                >
...
export default {
  ...
  methods: {
    ...
    layThongTinTimKiem() {
      ...
      if (this.inputValue.tt_tracu != "") {
        dieukien =
          this.tieuchi_selected != null
            ? this.tieuchi_selected.replace(":values", this.inputValue.tt_tracu)
            : 0;
      }
      ...
      let dk_tracuu = this.danhsach_tieuchi.find(
        item => item.ID == this.tieuchi_selected
      );
