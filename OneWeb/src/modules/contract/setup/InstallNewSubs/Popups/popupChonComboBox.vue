...
export default {
    ...
    mounted() {
        this.ds = this.dulieu.ds;
        for(var item of this.ds.list) {
            if(!item[this.ds.valuecol]) item[this.ds.valuecol] = 0;
            if(!item[this.ds.textcol]) item[this.ds.textcol] = '';
        }
        if(this.ds.list && this.ds.list.length>0 && !this.dulieu.ds.value) this.ds.value = this.ds.list[0][this.ds.valuecol];
        if(this.dulieu.ds.value) this.ds.value = this.dulieu.ds.value;
