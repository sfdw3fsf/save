        ...
        <div class="row">
            <div class="col-12">
                <div class="box-form">
                    ...
                    <ejs-grid ref="grid" :dataSource="ds.list" locale="vi-VN" :allowSorting='true' :allowFiltering='true' @recordClick="grid_Click"
...
export default {
    ...
    methods: {
        ...
        grid_Click: function(args) {            
            if (args.rowData.flag == 0)
                args.row.classList.add('disabled')
        },
    }
}
</script>
