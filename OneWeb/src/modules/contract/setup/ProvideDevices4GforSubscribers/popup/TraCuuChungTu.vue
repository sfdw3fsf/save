...
<style src='@/modules/QLVT/TraCuuChungTu/TraCuuChungTu.scss'></style>
<script>
...
import Vue from "vue";
import NhapXuatVT from "@/modules/QLVT/NhapXuatVT/NhapXuatVT.vue";
...
export default {
  ...
  methods: {
    ...
    tsbtnDongY_Click() {
         ...
         this.row_selected.SOPHIEU=this.so_phieu
        this.$emit('form-close', this.row_selected);
    ...
    //   this.xacnhan = true;
    //   // Tú
    //   this.$emit('form-close', "tú kiểm tra");
    ...
    selectedRowChanged(args) {
      this.row_selected= args
      console.log("gridChungTuVatTu_selectedRowChanged",args);
    },
