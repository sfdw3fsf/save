    ...
    <div class="popup-body">
        <div class="row">
            <div class="legend-title mart20">
                Thông tin tìm kiếm
                <div class="right" style="width:150px;"><select2 v-model="tinhkn.value" class="select-custom" :options="tinhkn.list.map(ls=>({id:ls.TINH_ID,text:ls.TENTINH}))"></select2></div>
            </div>
...
export default {
    ...
    methods: {
        showModal() {
            this.$refs["popupDSHuongKNV2"].show()
        },
        handleShowModal() {
        ...
        hideModal() {
            this.$refs["popupDSHuongKNV2"].hide()
        },
        ...
        chapnhan() {
            ...
            if(!obj || !obj['id_sochinh']) this.$emit('form-close',null);
                ...
                this.$emit('form-close',{iid_sochinh:obj['id_sochinh'],iloai:obj['loai'],shuongkn:obj['vrf_vfi']?obj['vrf_vfi']:obj['huong_kn'],vma_tb:obj['vrf_vfi']?obj['vrf_vfi']:obj['ma_tb'],diachi_ld:obj['diachi_ld'],itinh_kn_id:this.tinhkn.value,});
        },
