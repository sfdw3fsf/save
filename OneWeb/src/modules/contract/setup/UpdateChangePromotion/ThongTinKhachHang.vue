  ...
  <div class="col-sm-6 col-12">
    <div class="box-form">
      ...
      <div class="row">
        <div class="col-sm-8 col-12">
          <div class="info-row">
            ...
            <div class="value">
              <input type="text" class="form-control" ref="inputMaHD" @keypress="evt=>evt.preventDefault()" :value="input_ma_hd" @change="e=>input_ma_hd=e.target.value"/>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4 col-12">
          <div class="info-row">
            ...
            <div class="value">
              <input type="text" class="form-control" ref="inputMaKH" @keypress="evt=>evt.preventDefault()" :value="input_makh" @change="e=>input_makh=e.target.value"/>
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-12">
      ...
      <div class="row">
        <div class="col-sm-8 col-12">
          <div class="info-row">
            ...
            <div class="value">
              <input type="text" ref="inputTenKH" class="form-control" @keypress="evt=>evt.preventDefault()" :value="input_ten_kh" @change="e=>input_ten_kh=e.target.value"/>
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-12">
      ...
      <div class="info-row">
        ...
        <div class="value">
          <input type="text" class="form-control" @keypress="evt=>evt.preventDefault()" :value="input_diachi_kh" @change="e=>input_diachi_kh=e.target.value"/>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-8 col-12">
          <div class="info-row">
            ...
            <div class="value">
              <input type="text" class="form-control" ref="inputTenTB" @keypress="evt=>evt.preventDefault()" :value="input_ten_tb" @change="e=>input_ten_tb=e.target.value"/>
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-12">
          <div class="info-row">
            ...
            <div class="value">
              <input type="text" class="form-control" ref="inputSoThangCK" @keypress="isNumber($event)" :value="input_thang_ck" @change="e=>input_thang_ck=e.target.value"/>
            </div>
          </div>
        </div>
      </div>
      <div class="info-row">
        ...
        <div class="value">
          <div class="input-more-button">
            ...
            <input type="text" class="form-control" @keypress="evt=>evt.preventDefault()" :value="input_diachi_tb" @change="e=>input_diachi_tb=e.target.value"/>
          </div>
        </div>
      </div>
      <div class="info-row">
        ...
        <div class="value">
          <div class="input-more-button">
            ...
            <input type="text" class="form-control" @keypress="evt=>evt.preventDefault()" :value="input_diachi_ld" @change="e=>input_diachi_ld=e.target.value"/>
          </div>
        </div>
      </div>
    </div>
