                ...
                <div class="row">
                    <div class="col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="goicuoc_dd_moi_selected" class="form-control">
                                        <option v-for="item in ds_goicuoc_dd_moi" :key="item.GOICUOC_ID" :value="item.GOICUOC_ID">
                                            {{item.TENGOICUOC}}
                                        </option>
                                    </select>
                                </div>
...
export default {
    ...
    methods:{
        ...
        async initDuLieu(ds_loaihinh_tb){
            ...
            //
            this.ds_loaihinh=ds_loaihinh_tb.filter(x=>x.DICHVUVT_ID==2)
