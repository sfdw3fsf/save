        ...
        <div class="col-sm-6 col-12">
            <div class="box-form">
                        ...
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="input-more-button">
                                    ...
                                    <input type="text" ref="refInputMaTB" @keyup.enter="onEnterMaTB" class="form-control highlight" :value="input_matb" @change="e=>input_matb=e.target.value">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="tocdo_selected" :disabled="disableGoiCuocADSLCu" class="form-control">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="muccuoc_selected" class="form-control">
                                        <option v-for="item in ds_muccuoc" :key="item.muccuoc_id" :value="item.muccuoc_id">
                                            {{item.tenmuc}}
                                        </option>
                                    </select>
                                </div>
                ...
                <div class="info-row">
                    ...
                    <div class="value">
                        <div class="select-custom">
                            <select v-model="tocdothuc_selected" :disabled="disableTocDoADSLCuThuc" class="form-control">
                                <option v-for="item in ds_tocdo" :key="item.tocdo_id" :value="item.tocdo_id">
                                    {{item.thuonghieu}}
                                </option>
                            </select>
                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="loaithietbi_selected" class="form-control">
                        ...
                        <div class="info-row">
                            ...
                            <div class="value">
                                <select ref="cboLoaiHinhTBMoi" v-model="loaihinh_tb_moi_selected" @change="changeLoaiHinhTBMoi" :disabled="disableLoaiHinhTB" class="form-control">
                                    <option v-for="item in ds_loaihinh_moi" :key="item.LOAITB_ID" :value="item.LOAITB_ID">
                                        {{item.LOAIHINH_TB}}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="input-more-button">
                                    ...
                                    <input type="text" class="form-control" @keypress="evt=>evt.preventDefault()" :value="input_khuvuc" @change="e=>input_khuvuc=e.target.value">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <ejs-dropdownlist 
                                    :allowFiltering="true"
                                    :enabled="!disableGoiCuocADSLMoi"
                                    v-model="tocdo_moi_selected"
                                    :filtering="onFilteringTocDo"
                                    @change="changeGoiCuocAdsl"
                                    :dataSource="ds_tocdo_moi"
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="muccuoc_moi_selected" @change="changeMucCuoc" class="form-control">
                                        <option v-for="item in ds_muccuoc" :key="item.muccuoc_id" :value="item.muccuoc_id">
                                            {{item.tenmuc}}
                                        </option>
                                    </select>
                        ...
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <ejs-dropdownlist 
                                        :allowFiltering="true"
                                        :enabled="checkTocDoThuc"
                                        v-model="tocdo_thuc_selected"
                                        :filtering="onFilteringTocDoThuc"
                                        :dataSource="ds_tocdo_thuc_moi"
                                        :fields="{ text: 'thuonghieu', value: 'tocdo_id' }" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="loaithietbi_moi_selected" :disabled="!enableLoaiTBi" class="form-control">
                                        <option v-for="item in ds_loaithietbi" :key="item.thietbidc_id" :value="item.thietbidc_id">
                                            {{item.ten_tbi}}
                                        </option>
                                    </select>
...
export default {
    ...
    methods:{
        ...
        formCloseDSTBCungDoiCap(value){
            ...
            this.input_madoicap_adsl=value.MADOICAP
        },
        ...
        changeGoiCuocAdsl(){
            if(!this.isChangeGoiCuocADSL){
                this.isChangeGoiCuocADSL=true
                return
            }
        ...
        onFilteringTocDo(e){
            ...
            if (e.text.trim() !== ''){
                predicate  = new Predicate('thuonghieu', 'contains', e.text.trim(), true);
                query.where(predicate)
            }
            //pass the filter data source, filter query to updateData method.
            e.updateData(this.ds_tocdo_moi, query);
        },
        onFilteringTocDoThuc(e){
            var query = new Query();
            let predicate;  
            //frame the query based on search string with filter type.
            if (e.text.trim() !== ''){
            ...
            //pass the filter data source, filter query to updateData method.
            e.updateData(this.ds_tocdo_thuc_moi, query);
        },
        ...
        async initDuLieu(ds_loaihinh_tb){
            ...
            this.ds_loaihinh_moi=ds_loaihinh_tb.filter(x=>x.DICHVUVT_ID==4)
