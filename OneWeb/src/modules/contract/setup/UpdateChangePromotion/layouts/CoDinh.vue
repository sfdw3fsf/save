        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-12">
            <div class="info-row">
              ...
              <div class="value">
                <input type="text" class="form-control tright" disabled :value="input_cuoctb" @change="e=>input_cuoctb=e.target.value"/>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="value">
                <div class="select-custom">
                  <select ref="cboLoaiHinhTBMoi" v-model="loaihinh_tb_moi_selected" @change="changeLoaiHinhTBMoi" :disabled="disableLoaiHinhTB" class="form-control">
                    <option v-for="item in ds_loaihinh_tb_moi" :key="item.LOAITB_ID" :value="item.LOAITB_ID">
                      {{item.LOAIHINH_TB}}
                    </option>
                  </select>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-12">
            <div class="info-row">
              ...
              <div class="value">
                <div class="select-custom">
                  <select v-model="loai_so_moi_selected" class="form-control" @change="changeLoaiSoMoi" :disabled="inputLoaiSoMoiDisabled">
                    <option v-for="item in ds_loaiso" :key="item.loaiso_id" :value="item.loaiso_id">
                      {{item.loaiso}}
                    </option>
                  </select>
...
import ChonSoChinhModal from '../popups/ChonSoChinhModal.vue'
    ...
    methods:{
      ...
      async HienThiTT_DanhBaV2(item){
        ...
        if(item.thuebao_cha_id!=null&&item.thuebao_cha_id!=''){
          this.input_sochinh_moi=await this.fn_map_id({
            id_neo: "ma_tb",
            table: "css.db_thuebao",
            dk:"where thuebao_id = "+item.thuebao_cha_id
          },'')
