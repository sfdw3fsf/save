                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="trangbi_moi_selected" @change="changeTrangBiMoi" class="form-control">
                                        <option v-for="item in ds_trangbi" :key="item.trangbi_id" :value="item.trangbi_id">
                                            {{item.tentrangbi}}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    <div class="col-sm-8 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="loaithietbi_moi_selected" class="form-control">
                                        <option v-for="item in ds_loaithietbi" :key="item.thietbidc_id" :value="item.thietbidc_id">
                                            {{item.ten_tbi}}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="doitac_moi_selected" class="form-control" :disabled="!checkDoiTacMoi">
                                        <option v-for="item in ds_doitac" :key="item.doitac_id" :value="item.doitac_id">
                                            {{item.ten_dt}}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="lcapdau_moi_selected" class="form-control">
                                        <option v-for="item in ds_lcap" :key="item.loaicap_id" :value="item.loaicap_id">
                                            {{item.loaicap}}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="lcapcuoi_moi_selected" class="form-control">
                                        <option v-for="item in ds_lcap" :key="item.loaicap_id" :value="item.loaicap_id">
                                            {{item.loaicap}}
                                        </option>
                                    </select>
...
export default {
    ...
    methods:{
        ...
        async HienThiTTMoRong_DB(item){
            ...
            this.trangbi_selected=item.TRANGBI
