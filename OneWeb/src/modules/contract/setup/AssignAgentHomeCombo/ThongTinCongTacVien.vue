<template>
  <div class="col-sm-4 col-12">
    <div class="box-form">
      <div class="legend-title">Thông tin cộng tác viên</div>
...
export default {
  ...
  data() {
    return {
      ...
      nhom_selected:null,
      danh_sach_nhom:[],
      nhanvien_selected:this.hdtb.nhanvien_id,
  ...
  watch:{
    hdtb:function(newVal, oldVal){
      ...
      this.nhom_selected=null
      this.danhsach_nhanvien=this.all_nhanvien
      this.nhanvien_selected=newVal.nhanvien_id
    },
