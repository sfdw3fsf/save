                ...
                <div class="row" v-for="(item, index) in ds_tien_km" :key="index">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric class="form-control tright" separator="," :value="item.tongtien" @blur="handleBlur($event, 1, index)" @change="changeTongTien($event, index)" placeholder="0" output-type="Number"></vue-numeric>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric class="form-control tright" separator="," :value="item.tien" @blur="handleBlur($event, 2, index)" @change="changeTien($event, index)" placeholder="0" output-type="Number"></vue-numeric>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric class="form-control tright" separator="," :value="item.vat" @change="changeVat($event, index)" placeholder="0" output-type="Number"></vue-numeric>
