    ...
    data(){
        return {
            ...
            ds_dichvu:[
              ...
              {
                dichvuvt_id: 25,
                ten_dvvt: "Kênh điểm - điểm Nội bộ VNPT"
              },
              {
                dichvuvt_id: 26,
                ten_dvvt: "Kênh đa điểm Nội bộ VNPT"
              },
    ...
    computed:{
      ds_loaihinh_theo_dv(){
        if(this.dichvu_selected==DichVuVienThong.DI_DONG){
          ...
          //11,58,61,//57,59
          return this.ds_loaihinh.filter(x=>(x.DICHVUVT_ID==DichVuVienThong.ADSL)&&(x.LOAITB_ID==11||x.LOAITB_ID==58||x.LOAITB_ID==61))
        }else{
