export default {
    ...
    // }),
    sp_lay_ds_hdtb_theo_hdtb_ban: async (axios, hdtb_id) => axios.post('/web-bancheo/tracuu/sp_lay_ds_hdtb_theo_hdtb_tc_bc', {
        hdtb_id: hdtb_id
    }),
    ...
    sp_ins_hdtb_hen_bc: async (axios, js_hdtb_hen) => axios.post('/web-bancheo/tracuu/sp_ins_hdtb_hen_bc',{
    js_hdtb_hen: js_hdtb_hen,
    }),
    sp_lay_ds_hdtb_hen_bc: async (axios, hdtb_id) => axios.post('/web-bancheo/tracuu/sp_lay_ds_hdtb_hen_bc',{
        hdtb_id: hdtb_id
    }),
}
