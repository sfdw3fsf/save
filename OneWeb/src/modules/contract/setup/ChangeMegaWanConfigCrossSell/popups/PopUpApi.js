export default {
  ...
  // frmDsThueBaoWan
  lay_chuquan_macdinh_theo_donvi_bancheo: (axios) => axios.get('web-hopdong/hopdong/lay_chuquan_macdinh_theo_donvi_bancheo'),

  bancheo_kiemtra_dichvu_vnpti: (axios, loaitb_id, loaihd_id, dichvuvt_id) => axios.get(`web-hopdong/hopdong/bancheo_kiemtra_dichvu_vnpti?loaitb_id=${loaitb_id}&loaihd_id=${loaihd_id}&dichvuvt_id=${dichvuvt_id}`),
  
  fn_frmthongsowan_load: (axios, data) => axios.post('web-thicong/capnhatthongtin/fn_frmthongsowan_load', data),
