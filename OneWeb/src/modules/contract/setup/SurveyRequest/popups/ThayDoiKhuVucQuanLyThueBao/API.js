export default {
    ...
    lay_ds_nhanvien_khuvuc: async (axios, khuvuc_id) => axios.post('/web-ccdv/hieuchinhhopdong/lay_ds_nhanvien_khuvuc', {
        vkhuvuc_id:khuvuc_id
    }),

    lay_ds_nhanvien_kv_theo_hdtb_id: async (axios, hdtb_id) => axios.post('/web-ccdv/hieuchinhhopdong/lay_ds_nhanvien_kv_theo_hdtb_id', {
        vhdtb_id:hdtb_id
    }),

    sp_ins_hdtb_kv_v2: async (axios, data) => axios.post('/web-ccdv/hieuchinhhopdong/sp_ins_hdtb_kv_v2', {
        js_hdtb_kv:data
    }),
