      ...
      <div class="popup-body">
        <div class="box-form">
          <div class="legend-title">
            ...
            <div class="pull-right bold red" v-if="rowSelected!=null">Người giới thiệu: {{ten_ht_selected}}</div>
        ...
        <div class="box-form">
          ...
          <KDataGrid
              ...
              @selectedItemsChanged="gridDanhSachNguoiGTChanged"/>
        </div>
      </div>
    </div>
  </b-modal>
...
export default {
    ...
    methods:{
        ...
        gridDanhSachNguoiGTChanged(data){
