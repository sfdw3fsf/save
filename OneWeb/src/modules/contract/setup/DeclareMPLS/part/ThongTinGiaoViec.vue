<template>
  <div class="box-form" :style="{ minHeight: visible ? '290px' : '90px' }" style="padding: 22px 12px;">
      ...
      <div class="col-sm-6 col-12">
        ...
        <div class="info-row">
          ...
          <div class="value d-flex">
            <div class="value w20 padt7 pl-0">
              <div class="check-action">
                <input
                ref="chkNgayGV"
                  type="checkbox"
                  class="check"
                   :disabled="formProps.dischkNgayGV"
                  v-model="formProps.chkNgayGV"
                />
       ...
       <div class="col-sm-6 col-12">    
        ...
        <div class="info-row">
          ...
          <div class="value d-flex">
            <div class="value w20 padt7 pl-0">
              <div class="check-action">
                <input
                  type="checkbox"
                  class="check"
                  :disabled="formProps.dischkNgayBG"
                  v-model="formProps.chkNgayBG"
                />
                <span class="name"></span>
              </div>
            </div>
            <date-picker
              style="width: 100%"
              v-model="formProps.dtpNgayBG"
              placeholder="dd/mm/yyyy"
              :disabled="formProps.disNgayBG"
              :type="'datetime'"
              :format="'hh:mm'"
              :time-picker-options="timePickerOptions"
              :formatter="momentFormat"
