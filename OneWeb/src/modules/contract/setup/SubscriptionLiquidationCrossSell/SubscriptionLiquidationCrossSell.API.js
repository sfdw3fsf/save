...
export default {
  ...
  layhuonggiao_tiepnhan_bc_v4: (tinhthicong_id, loaihd_id, loaitb_id, tocdo_id, muccuoc_id, kieuld_id,loaikenh_id,dichvuvt_id) => axios.post(`web-bancheo/danhmuc/layhuonggiao_tiepnhan_v4`, {
    tinhthicong_id: tinhthicong_id,
    loaihd_id,
    loaitb_id,
    tocdo_id,
 ...
 sp_lay_ds_kenhtoantrinh_tb: async (axios,data) => axios.post("/web-bancheo/tracuu/sp_lay_ds_kenhtoantrinh_tb",data)
}
