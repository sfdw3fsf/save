...
export default {
  ...
  methods: {
    ...
    async clear() {
        ...
        this.$refs.v3_ThongTinThueBao.model.v3_thoi_han_ck = "";
        this.$refs.v3_ThongTinThueBao.model.v3_thoi_han_ck_disabled = false;
    ...
    async cboKieuLD_SelectedValueChanged(e) {
        let _kieuld = e
        this.$refs.v3_ThongTinThueBao.v3_thoi_han_ck_disabled = true
        if(_kieuld == this.KIEULAPDAT.VTI_DOI_GiACUOC_TSL && this.$root.token.getPhanVungID() == 98){
            this.$refs.v3_ThongTinThueBao.v3_thoi_han_ck_disabled = false
        }
    ...
    async HienThiDanhSacHDTB(dataSource) {
        ...
        if (dataSource.length > 0) {
            ...
            this.$refs.v3_ThongTinThueBao.model.v3_thoi_han_ck = parseInt(dataSource[0].sothang_ck);
            await this.setButton(3);
        } else {
            this.clear();
            this.v5_dtDSThueBao = []
            ...
            if (this.thuebao_id > 0) {
                if (this.dichvuvt_id == this.DichVuVienThong.TSL || this.dichvuvt_id == 25) {
                    ...
                    if (dt.length > 0) {
                        ...
                        this.$refs.v3_ThongTinThueBao.model.v3_ma_bss = dt[0].ma_bss;
                        this.$refs.v3_ThongTinThueBao.model.v3_ma_erp = dt[0].id_erp;
    ...
    KiemTraDL_ThueBao() {
        if ((this.$refs.v2_ThongTinPhieuYeuCau.model.v2_ma_hop_dong == undefined || this.$refs.v2_ThongTinPhieuYeuCau.model.v2_ma_hop_dong == "") && this.khachhang_id != 0) {
    ...
    async TaoDuLieu_HDTB(themmoi) {
        ...
        let _kieuld = this.$refs.v2_ThongTinPhieuYeuCau.model.v2_kieu_yeu_cau
        let thoiHanCK = 0
        if(_kieuld == this.KIEULAPDAT.VTI_DOI_GiACUOC_TSL && this.$root.token.getPhanVungID() == 98){
            thoiHanCK = this.$refs.v3_ThongTinThueBao.model.v3_thoi_han_ck
        }
        rowHDTB.SOTHANG_CK = thoiHanCK;
    ...
    async TaoDuLieu_TDTD_TSL(themmoi) {
        ...
        for (let i = 0; i < ds.length; i++) {
            ...
            if (chkDoiTac.checked) {
                ...
                rowTDTD_TSL.MAHD_DT = this.$refs.v4_ThongTinKhachHang.model.v4_ma_hop_dong_dt ? this.$refs.v4_ThongTinKhachHang.model.v4_ma_hop_dong_dt.trim() : "";
            }
    ...
    async HienThiTT_DanhBa(ma_tb) {
        ...
        if (ds.stt != undefined && ds.stt != null) {
            ...
            this.$refs.v3_ThongTinThueBao.model.v3_thoi_han_ck = ds.sothang_ck;
            ...
            if (ds.length > 0) {
                ...
                if (ds[0].doitac_id != undefined && String(ds[0].doitac_id).trim() != "") {
                    ...
                    this.$toast.info("Thuê bao này có Hợp đồng/PLHĐ với đối tác " + str_doitac);
                } else {               
                    this.$refs.v4_ThongTinKhachHang.model.v4_ma_hop_dong_dt = "";
                    this.$refs.v4_ThongTinKhachHang.model.v4_cuoc_tkdt = "0";
                    this.$refs.v4_ThongTinKhachHang.model.v4_cuoc_tcdt = "0";
