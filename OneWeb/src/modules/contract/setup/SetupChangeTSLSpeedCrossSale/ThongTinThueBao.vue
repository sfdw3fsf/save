    ...
    <div class="box-col box-form">
        ...
        <div class="row">
            <div class="col-sm-12 col-12">
                <div class="info-row">
                    <div class="key">Thời hạn CK</div>
                    <div class="value">
                        <input style="text-align: right;"type="number" min="0" class="form-control" v-model="model.v3_thoi_han_ck" :disabled="v3_thoi_han_ck_disabled">
                    </div>
                </div>
            </div>
        </div>
