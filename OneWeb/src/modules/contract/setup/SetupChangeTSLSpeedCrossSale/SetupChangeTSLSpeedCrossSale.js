export default {
  ...
  lay_thongtin_hdtb_tsl: (axios, data) => axios.get(`/web-hopdong/hopdong/lay_thongtin_hdtb_tsl?hdtb_id=${data.hdtb_id}`, data),
  lay_thongtin_dbtb_dv: (axios, data) => axios.get(`/web-hopdong/hopdong/lay_thongtin_dbtb_dv?thuebao_id=${data.thuebao_id}`, data),
  lay_thongtin_tinh: (axios, data) => axios.get(`/web-hopdong/hopdong/lay_thongtin_tinh?tinh_id=${data.tinh_id}`, data),
  lay_thongtin_tinh_dm_tinh_ketnoi: (axios, data) => axios.get('/web-hopdong/hopdong/lay_thongtin_tinh_dm_tinh_ketnoi', data),

  // ban cheo
  SP_LAY_DS_THAMSO_MD: async (axios, data) => axios.post('/web-hopdong/khaibaotsl/sp_lay_ds_thamso_md', data),
  layhuonggiao_tiepnhan_v2: async (axios, data) => axios.post('/web-hopdong/khoiphucthanhly/layhuonggiao_tiepnhan_v2', data),
  layhuonggiao_tiepnhan: async (axios, data) => axios.post('/web-bancheo/tracuu/layhuonggiao_tiepnhan_bancheo', data),
  lay_khachhangid_thicong: async (axios, data) => axios.post('/web-bancheo/tracuu/lay_khachhangid_thicong', data),
  lay_danhba_theo_thuebaoid: async (axios, data) => axios.post('/web-bancheo/tracuu/lay_danhba_theo_thuebaoid', data),
  fn_tt_muccuoc_tb: async (axios, data) => axios.post('/web-bancheo/tracuu/fn_tt_muccuoc_tb', data),
  lay_ds_db_tsl_theo_tbid: async (axios, data) => axios.post('/web-bancheo/tracuu/lay_ds_db_tsl_theo_tbid', data),
  ...
  lay_tinhthicong_theo_matb: async (axios, data) => axios.get(`web-hopdong/hopdong/lay_tinhthicong_theo_matb?matb=${data.matb}`, data),
  themmoi_hdbancheo_biendong: async (axios, data) => axios.post('/web-hopdong/hopdong/themmoi_hdbancheo_biendong', data),
  capnhat_hdbancheo_biendong: async (axios, data) => axios.post('/web-hopdong/hopdong/capnhat_hdbancheo_biendong', data),
