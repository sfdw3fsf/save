<template>
    <div>
        <ejs-dialog :allowDragging="true" :enableResize="true" :visible="false" :animationSettings="animationSettings"
            :position="{ X: 'center', Y: 'top' }" ref="popupMapChuQuan" width="85%" :isModal='true' :target="target"
            :close="hideModal">
            <div class="modal-content popup-box">
                <div class="popup-header">
                    <div class="title"><span class="icon one-notepad"></span>Map thuê bao </div>
                            ...
                            <div class="col-sm-6 col-6">
                                <div class="box-form">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <div class="value">
                                            <div class="input">
                                                <input type="text" class="form-control" v-model="txtMaTB_TTC.value"
        ...
        async onClickSearch_TB() {
            try {
                ...
                if (this.kiemTra(this.txtMaTB_TB.value)) {
                    this.$toast.warning('Mã thuê bao tỉnh bán chứa ký tự không hợp lệ!')
                    return
                }
        ...
        async onClickSearch_TTC() {
            try {
                ...
                if (this.kiemTra(this.txtMaTB_TTC.value)) {
                    this.$toast.warning('Mã thuê bao tỉnh thi công chứa ký tự không hợp lệ!')
                    return
                }
                if (!this.txtMaTB_TB.value) {
                    this.gridTinhBan.listBan = []
