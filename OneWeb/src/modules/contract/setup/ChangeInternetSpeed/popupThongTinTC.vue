                        ...
                        <div class="value" :class="{disabled:thongso_tc!=1 }">
                            <div class="input-icon-right">
                               <!--  <date-picker input-class="form-control" :format="dateFormat" :value-type="'format'" v-model="txtngiam"></date-picker>
                                ...
                                <ejs-datepicker v-model="txtngiam"
                                    :format="'dd/MM/y'" :showClearButton="false" 
                                    :disabled="true" :placeholder="'__/__/____'">
                                </ejs-datepicker>
                            </div>
                        </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="value" :class="{disabled:thongso_tc!=1 }">
                            <div class="input-icon-right">
                                ...
                                <span class="icon one-calendar"></span> -->
                                <ejs-datepicker v-model="txtngiamip"
                                    :format="'dd/MM/y'" :showClearButton="false" 
                                    :disabled="true" :placeholder="'__/__/____'">
                                </ejs-datepicker>
                            </div>
                        ...
                        <div class="value" :class="{disabled:thongso_tc!=1 }">
                            <div class="input-icon-right">
                               <!--  <date-picker input-class="form-control" :format="dateFormat" :value-type="'format'" v-model="txtngiamemail"></date-picker>
                                <span class="icon one-calendar"></span> -->
                                <ejs-datepicker v-model="txtngiamemail"
                                    :format="'dd/MM/y'" :showClearButton="false" 
                                    :disabled="true" :placeholder="'__/__/____'">
                                </ejs-datepicker>
                            </div>
...
import {
  LoaiHinhTB,
} from "@/modules/contract/setup/InstallNewSubs/Enums";
export default {
    ...
    async mounted() {
        ...
        this.thongso_tc = rs.data[0].ten_ts;
