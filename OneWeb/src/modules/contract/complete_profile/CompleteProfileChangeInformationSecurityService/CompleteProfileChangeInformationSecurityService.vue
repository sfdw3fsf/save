<template src="./CompleteProfileChangeInformationSecurityService.html"></template>
<style src="./CompleteProfileChangeInformationSecurityService.scss"></style>
...
<script>
import api from "./CompleteProfileChangeInformationSecurityServiceAPI.js";
...
export default {
  ...
  data() {
    return {
      isDisplayMenu: false,
      header: {
        title: "Hoàn thiện hồ sơ Thay đổi dịch vụ ATBTT - dịch vụ CNTT",
        list: [
          //  Hoàn thiện HS -> Hoàn thiện hồ sơ Thay đổi dịch vụ ATBTT - dịch vụ CNTT
          { name: " Hoàn thiện HS", link: { name: "Ui.cards" } },
          {
            name: "Hoàn thiện hồ sơ Thay đổi dịch vụ ATBTT - dịch vụ CNTT",
