<template src="./CompleteProfileChangeMobileService.html"></template>
<style src="./CompleteProfileChangeMobileService.scss"></style>
...
<script>
import api from "./CompleteProfileChangeMobileServiceAPI.js";
...
export default {
  ...
  data() {
    return {
      isDisplayMenu: false,
      header: {
        title: "Hoàn thiện hồ sơ đổi dịch vụ di động",
        list: [
          //  Hoàn thiện HS -> Hoàn thiện hồ sơ đổi dịch vụ di động
          { name: " Hoàn thiện HS", link: { name: "Ui.cards" } },
          {
            name: "Hoàn thiện hồ sơ đổi dịch vụ di động",
  ...
  methods: {
    ...
    hideDropdownMenu(e) {
      if (e.target !== this.$refs.referenceRefsDots) {
