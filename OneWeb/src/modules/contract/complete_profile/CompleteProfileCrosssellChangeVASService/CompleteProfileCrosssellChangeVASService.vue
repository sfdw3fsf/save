<template src="./CompleteProfileCrosssellChangeVASService.html"></template>
<style src="./CompleteProfileCrosssellChangeVASService.scss"></style>
...
<script>
import api from "./CompleteProfileCrosssellChangeVASServiceAPI.js";
...
export default {
  ...
  data() {
    return {
      isDisplayMenu: false,
      header: {
        title: "HTHS Thay đổi dịch vụ gia tăng tỉnh khác (Bán chéo)",
        list: [
          //  Hoàn thiện HS -> Hoàn thiện hồ sơ Bán chéo -> HTHS Thay đổi dịch vụ gia tăng tỉnh khác (Bán chéo)
          { name: " Hoàn thiện HS", link: { name: "Ui.cards" } },
          { name: "Hoàn thiện hồ sơ Bán chéo", link: { name: "Ui.cards" } },
          {
            name: "HTHS Thay đổi dịch vụ gia tăng tỉnh khác (Bán chéo)",
  ...
  methods: {
    ...
    btnHoanCongOnClick() {
      alert("btnHoanCongOnClick");
    },
    btnHoanThanhOnClick() {
      alert("btnHoanThienOnClick");
    },
    btnVatTuOnClick() {
      alert("btnVatTuOnClick");
    },
    btnXuatFileOnClick() {
      alert("btnXuatFileOnClick");
    },
    btnDanhSachOnClick() {
      alert("btnDanhSachOnClick");
    },
    btnThoaiTraOnClick() {
      alert("btnThoaiTraOnClick");
    },
    ...
    btnHenLDOnClick() {
      alert("btnHenLDOnClick");
    },
     btnXuatPhieuOnClick() {
      alert("btnXuatPhieuOnClick");
    },
      btnThongSoKTOnClick() {
      alert("btnThongSoKTOnClick");
    },
      btnDuAnOnClick() {
      alert("btnDuAnOnClick");
    },
    setDisplayDropDownMenu() {
      this.isDisplayMenu = !this.isDisplayMenu;
    },
    hideDropdownMenu(e) {
      if (e.target !== this.$refs.dots) {
