export const DichVuVienThong = {
  ...
  MGW_DOITAC: 23,
  TSL_DOITAC: 24,
  listDichVuCoCap: function () {
    return [CO_DINH, ADSL, MEGAWAN, TSL, IMS]
  },
  listDichVuCNTT: function () {
    return [DICHVU_CNTT, TRUNGTAM_DULIEU, ANTOAN_BAOMAT_TT, HOINGHI_TRUYENHINH]
  },
}
