...
export default{ 
     ...
     async LAY_DS_NHANVIEN_THEO_PHIEU_ID(axios, phieu_id,  nhanvien_id, kieu_id){  
         var data = {};
         var dataPost = {
            "phieu_id": phieu_id,
        ...
        await  CompleteProfileAPI.lay_ds_nhanvien_theo_phieu_id(axios, dataPost).then(res=>{  
            if (res && res.data && res.data.data && res.data.error_code && res.data.error_code === 'BSS-00000000') {
                data = res.data.data;  
            }
        }); 
     ...
     async LAY_DS_DANGKY_DVGT(axios, hdtb_id){  
         var data = {};
         var dataPost = {
            "vhdtb_id": hdtb_id
         }
        await  CompleteProfileAPI.lay_ds_dangky_dvgt(axios, dataPost).then(res=>{  
            if (res && res.data && res.data.data && res.data.error_code && res.data.error_code === 'BSS-00000000') {
                data = res.data.data;  
            }
        }); 
