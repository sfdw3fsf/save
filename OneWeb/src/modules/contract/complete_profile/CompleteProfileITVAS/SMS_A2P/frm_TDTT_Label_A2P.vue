...
<template>
  <ejs-dialog
    ...
    :position="position"
    :header="'Kích hoạt thay đổi thông tin Brandname'"
    showCloseIcon="true"
    width="75%"
  ...
  >
    ...
    <div class="dialogCreateIssue">
      ...
      <div class="popup-body">
        ...
        <div class="box-form">
          <div class="legend-title">Yêu cầu thay đổi thông tin Brandname</div>
          <div class="row">
            <div class="col-sm-12 col-12">
  ...
  methods: {
    ...
    async LoadDanhMuc() {
      ...
      if (ds.result_data.length > 0) {
        ...
        status = parseInt(dt["status"]);
      }
      console.log("log 2");
      if (status = 1) this.SetButton(2);
