...
import api2 from '@/modules/contract/complete_profile/CompleteProfileITVAS/popups/popupLayDuLieuBC/PopUpApi' 
...
export default {
  ...
  methods: {
    ...
    openDialog(dsbaoCao) { 
      ...
      this.$toast.error("Popup này bỏ rồi, AE nào đang dùng thì đổi sang popup Lê Kỳ làm nhé!");
      return;
      ...
      console.log('LayDuLieuBC: ds=', this.dsbaoCao)  
      ...
      this.DsHeader.data = keyNames.map((x) => ({ column_name: x.toUpperCase() }));
      
      console.log('this.$refs.dialogLayDuLieuBC.show()');
    ...
    tsbtnXemDL_Click(){
      ...
      console.log('this.ds_temp ', this.ds_temp );
      ...
      console.log('this.DsPhieu.data', this.DsPhieu.data);
    }, 
    bodauTiengViet(str) {
