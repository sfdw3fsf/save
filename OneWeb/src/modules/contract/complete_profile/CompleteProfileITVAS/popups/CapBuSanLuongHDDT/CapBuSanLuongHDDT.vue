<template>
  <ejs-dialog :enableResize="true" :isModal="true" allowDragging="true" zIndex="1000" :width="width" :visible="false" ref="dialogCapBuSanLuong" header="Cấp bù/Cắt giảm sản lượng dịch vụ hóa đơn điện tử" showCloseIcon="true" target="#app .main-wrapper">
    <div class="list-actions-top">
      <ul class="list">
        ...
        <li>
          <a href="#"> <span class="icon one-refresh"></span> Refresh </a>
        </li>
      </ul>
    </div>
      ...
      <div class="row">
        <div class="box-form">
          ...
          <div class="row">
            <div class="col-sm-6 col-12">
              <div class="info-row">
                <div class="key w120">SLHĐ trước 20/06/2023</div>
                <div class="value">
                  <input type="text" class="form-control" v-model="data_common.kq_tc_hddtn_convert.sl_hd_truoc_20062023" disabled />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
              <div class="info-row">
                <div class="key w90">SLHĐ sau 20/06/2023</div>
                <div class="value">
                  <input type="text" class="form-control" v-model="data_common.kq_tc_hddtn_convert.sl_hd_sau_20062023" disabled />
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6 col-12">
              <div class="info-row">
                <div class="key w120">Tên công ty</div>
                <div class="value">
                  <input type="text" class="form-control" v-model="data_common.kq_tc_hddtn.company_name" disabled />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-12">
              <div class="info-row">
                ...
                <div class="value">
                  <input type="text" class="form-control" v-model="data_common.kq_tc_hddtn_convert.ten_cty_viettat" disabled />
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    TongSL_HD_DADK() {
      const filteredServices = this.data_common.kq_tc_hddtn.invoices_services.filter((service) => service.service_type == 0)
