      ...
      <div class="list-actions-top">
        <ul class="list">
          ...
          <li>
            <a
              href="javascript:;"
              v-on:click="tsbtnGuiMailKH_Click"
              :class="{ disabled: !tsbtnGuiMailKH.Enabled }"
            >
              <span class="icon nc-icon-glyph ui-1_circle-remove"></span> Gửi Mail KH
            </a>
          </li>
          <li>
            <a
              href="javascript:;"
              v-on:click="tsbtnUpdate_Click"
              :class="{ disabled: !tsbtnUpdate.Enabled }"
            >
              <span class="icon nc-icon-glyph ui-1_circle-remove"></span> Bổ sung hồ sơ
            </a>
          </li>
        </ul>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-12">
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Vinaphone</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_vinaphone"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Loại nhãn Mobiphone</div>
                    <div class="value">
                      <SelectExt
                        v-model="controls.cboLoaiMobi.value"
                        :allowFiltering="true"
                        dataTextField="label_type_name"
                        dataValueField="label_type_id"
                        :dataSource="controls.cboLoaiMobi.list"
                      >
                      </SelectExt>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Mobiphone</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_vms"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Loại nhãn Viettel</div>
                    <div class="value">
                      <SelectExt
                        v-model="controls.cboLoaiVtl.value"
                        :allowFiltering="true"
                        dataTextField="label_type_name"
                        dataValueField="label_type_id"
                        :dataSource="controls.cboLoaiVtl.list"
                      >
                      </SelectExt>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Viettel</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_vtl"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Loại nhãn Vietnammobile</div>
                    <div class="value">
                      <SelectExt
                        v-model="controls.cboLoaiVnm.value"
                        :allowFiltering="true"
                        dataTextField="label_type_name"
                        dataValueField="label_type_id"
                        :dataSource="controls.cboLoaiVnm.list"
                      >
                      </SelectExt>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Vietnammobile</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_vnm"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Loại nhãn Gtel</div>
                    <div class="value">
                      <SelectExt
                        v-model="controls.cboLoaiGtel.value"
                        :allowFiltering="true"
                        dataTextField="label_type_name"
                        dataValueField="label_type_id"
                        :dataSource="controls.cboLoaiGtel.list"
                      >
                      </SelectExt>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Gtel</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_gtel"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Itel</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_itel"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    <div class="key">Giá Mobicast</div>
                    <div class="value">
                      <input
                        type="text"
                        class="form-control"
                        v-model="controls.gia_mbicast"
                      />
                    </div>
                  </div>
                </div>
...
export default {
  ...
  data() {
    return {
      ...
      controls: {
        ...
        cboLoaiMobi: { list: [], value: 0, Enabled: true },
        cboLoaiVtl: { list: [], value: 0, Enabled: true },
        cboLoaiVnm: { list: [], value: 0, Enabled: true },
        cboLoaiGtel: { list: [], value: 0, Enabled: true },
      ...
      grcDanhSach: {
        headers: [
          ...
          },
          {
            ...
            headerText: "Trạng thái Mobiphone",
            allowFiltering: true,
          },
          {
          ...
          },
          {
            ...
            headerText: "Trạng thái Vietnammobile",
            allowFiltering: true,
          },
          {
  ...
  watch: {
    ...
    "controls.cboLoaiMobi.value": async function (newValue, oldValue) {
      console.log("controls.cboLoaiMobi.value");
      console.log(newValue);
      let gia = await this.cboLoaiVina_EditValueChanged(newValue, 2);
      this.controls.gia_vms = parseInt(gia);
    },
    "controls.cboLoaiVtl.value": async function (newValue, oldValue) {
      console.log("controls.cboLoaiVtl.value");
      console.log(newValue);
      let gia = await this.cboLoaiVina_EditValueChanged(newValue, 3);
      this.controls.gia_vtl = parseInt(gia);
    },
    "controls.cboLoaiVnm.value": async function (newValue, oldValue) {
      console.log("controls.cboLoaiVnm.value");
      console.log(newValue);
      let gia = await this.cboLoaiVina_EditValueChanged(newValue, 5);
      this.controls.gia_vnm = parseInt(gia);
    },
    "controls.cboLoaiGtel.value": async function (newValue, oldValue) {
      console.log("controls.cboLoaiGtel.value");
      console.log(newValue);
      let gia = await this.cboLoaiVina_EditValueChanged(newValue, 4);
      this.controls.gia_gtel = parseInt(gia);
    },
  ...
  methods: {
    ...
    async LoadDanhMuc() {
      ...
      //HT_DS_LINHVUC_NHAMANG(cboLoaiMobi, 2);
      ...
      if (
        ...
        this.controls.cboLoaiMobi.list = data.data.data.data.items;
      }
      //HT_DS_LINHVUC_NHAMANG(cboLoaiVtl, 3);
      data = await api.LAY_DS_LINHVUC(this.axios, {
        telco_id: 3,
        contract_type_id: this.contract_type_id,
        agent_type: this.agent_type_id,
      ...
      if (
        ...
        this.controls.cboLoaiVtl.list = data.data.data.data.items;
      }
      //HT_DS_LINHVUC_NHAMANG(cboLoaiGtel, 4);
      data = await api.LAY_DS_LINHVUC(this.axios, {
        telco_id: 4,
        contract_type_id: this.contract_type_id,
        agent_type: this.agent_type_id,
      ...
      if (
        ...
        this.controls.cboLoaiGtel.list = data.data.data.data.items;
      }
      //HT_DS_LINHVUC_NHAMANG(cboLoaiVnm, 5);
      data = await api.LAY_DS_LINHVUC(this.axios, {
        telco_id: 5,
        contract_type_id: this.contract_type_id,
        agent_type: this.agent_type_id,
      ...
      if (
        ...
        this.controls.cboLoaiVnm.list = data.data.data.data.items;
      }
    ...
    async LoadThongTinBrandname() {
      ...
      if (dt && dt.length > 0) {
        ...
        this.controls.cboLoaiMobi.value =
          dt[0]["label_type_vms"] != 0 ? dt[0]["label_type_vms"] : -1;
        this.controls.cboLoaiVtl.value =
          dt[0]["label_type_vtl"] != 0 ? dt[0]["label_type_vtl"] : -1;
        this.controls.cboLoaiGtel.value =
          dt[0]["label_type_gtel"] != 0 ? dt[0]["label_type_gtel"] : -1;
        this.controls.cboLoaiVnm.value =
          dt[0]["label_type_vnm"] != 0 ? dt[0]["label_type_vnm"] : -1;
        ...
        this.controls.gia_vms = dt[0]["cuoc_sms_vms"];
        this.controls.gia_vtl = dt[0]["cuoc_sms_vtl"];
        this.controls.gia_gtel = dt[0]["cuoc_sms_gtel"];
        this.controls.gia_itel = dt[0]["cuoc_sms_vnm"];
    ...
    async LoadThongtinTrangthaiBRN() {
      if (this.label_id != 0) {
        ...
        for (let i = 0; i < this.dt.length; i++) {
          ...
          temp = this.dt[i].label_type_vms;
          this.dt[i].status_vms_name = this.dic.filter(
            (item) =>
              item.id ==
              (temp == "0" || temp == "" || temp == "-1"
                ? 4
                : parseInt(this.dt[i].status_vms))
          )[0].name;

          temp = this.dt[i].label_type_vtl;

          this.dt[i].status_vtl_name = this.dic.filter(
            (item) =>
              item.id ==
              (temp == "0" || temp == "" || temp == "-1"
                ? 4
                : parseInt(this.dt[i].status_vtl))
          )[0].name;

          temp = this.dt[i].label_type_gtel;
          this.dt[i].status_gtel_name = this.dic.filter(
            (item) =>
              item.id ==
              (temp == "0" || temp == "" || temp == "-1"
                ? 4
                : parseInt(this.dt[i].status_gtel))
          )[0].name;

          temp = this.dt[i].label_type_vnm;
          this.dt[i].status_vnm_name = this.dic.filter(
            (item) =>
              item.id ==
              (temp == "0" || temp == "" || temp == "-1"
                ? 4
                : parseInt(this.dt[i].status_vnm))
          )[0].name;
    ...
    async btnNhapMoi_Click() {
      ...
      let input = {
        ...
        label_type_vms: this.controls.cboLoaiMobi.value,
        label_type_vtl: this.controls.cboLoaiVtl.value,
        label_type_gtel: this.controls.cboLoaiGtel.value,
        label_type_vnm: this.controls.cboLoaiVnm.value,
        ...
        gia_vms: parseInt(this.controls.gia_vms),
        gia_vtl: parseInt(this.controls.gia_vtl),
        gia_gtel: parseInt(this.controls.gia_gtel),
        gia_vnm: parseInt(this.controls.gia_vnm),
      ...
      let obj = {
        ...
        vloai_vms: this.controls.cboLoaiMobi.value,
        vloai_vtl: this.controls.cboLoaiVtl.value,
        vloai_gtel: this.controls.cboLoaiGtel.value,
        vloai_vnm: this.controls.cboLoaiVnm.value,
        ...
        vgia_vms: parseInt(this.controls.gia_vms),
        vgia_vtl: parseInt(this.controls.gia_vtl),
        vgia_gtel: parseInt(this.controls.gia_gtel),
        vgia_vnm: parseInt(this.controls.gia_vnm),
    ...
    async btnCapNhat_Click() {
      ...
      for (let i = 0; i < dt.length; i++) {
        ...
        temp = dt[i].label_type_vms;
        temp2 = dt[i].status_vms;
        if (temp != "0" && temp != "" && temp != "-1") {
          if (temp2 == "0" || temp2 == "3" || temp2 == "2") {
            this.$toast.error(
              "Trạng thái mạng Mobifone đang duyệt, không thể hoàn thành"
            );
            return;
          }
        }

        temp = dt[i].label_type_vtl;
        temp2 = dt[i].status_vtl;
        if (temp != "0" && temp != "" && temp != "-1") {
          if (temp2 == "0" || temp2 == "3" || temp2 == "2") {
            this.$toast.error("Trạng thái mạng Viettel đang duyệt, không thể hoàn thành");
            return;
          }
        }

        temp = dt[i].label_type_gtel;
        temp2 = dt[i].status_gtel;
        if (temp != "0" && temp != "" && temp != "-1") {
          if (temp2 == "0" || temp2 == "3" || temp2 == "2") {
            this.$toast.error("Trạng thái mạng Gtel đang duyệt, không thể hoàn thành");
            return;
          }
        }

        temp = dt[i].label_type_vnm;
        temp2 = dt[i].status_vnm;
        if (temp != "0" && temp != "" && temp != "-1") {
          if (temp2 == "0" || temp2 == "3" || temp2 == "2") {
            this.$toast.error(
              "Trạng thái mạng Vietnamobile đang duyệt, không thể hoàn thành"
            );
            return;
          }
        }
