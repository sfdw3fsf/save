<template src="./CompleteProfileChangeService.html"></template>
<style src="./CompleteProfileChangeService.scss"></style>
...
<script>
import api from "./CompleteProfileChangeServiceAPI.js";
...
export default {
  ...
  data() {
    return {
      isDisplayMenu: false,
      header: {
        title: "Hoàn thiện hồ sơ Thay đổi dịch vụ",
        list: [
          // eslint-disable-next-line no-irregular-whitespace
          //  Hoàn thiện HS -> Hoàn thiện hồ sơ Thay đổi dịch vụ
          { name: "Hoàn thiện HS", link: { name: "Ui.cards" } },
          {
            name: "Hoàn thiện hồ sơ Thay đổi dịch vụ",
  ...
  methods: {
    ...
    hideDropdownMenu(e) {
      if (e.target !== this.$refs.referenceDost) {
