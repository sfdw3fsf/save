...
export default {
  ...
  computed: {
    fieldName: function () {
      if (!(this.column == null || this.column == undefined)) { return this.column.fieldName }
      return null
    },
    text: function () {
      if (!(this.dataItem == null || this.dataItem == undefined)) { return this.dataItem[this.fieldName] }
      return null
    },
    allowHtml: function () {
      if (!(this.column == null || this.column == undefined)) { return this.column.allowHtml }
      return false
    },
    EventArgs: function () {
      return {
