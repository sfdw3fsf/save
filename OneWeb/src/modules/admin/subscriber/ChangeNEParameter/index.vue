      ...
      <!-- <div class="main-wrapper">
        ...
        <div class="list-actions-top">
            <ul class="list">
                ...
                <li>
                    <a href="#">
                        <span class="icon files_single-content-02 nc-icon-glyph"></span> Hồ sơ
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="icon shopping_credit-card nc-icon-glyph"></span> Thanh toán
                    </a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="#">
                        <span class="icon objects_support-17 nc-icon-glyph"></span>Chăm sóc KH
                    </a>
                </li>
            </ul>
            <div class="more">
        ...
        <div class="page-content">
            <button @click="handleModal" data-toggle="modal" class="btn btn-action">Show modal</button>
        </div> -->
         <ThayDoiThongSoNe />
    <!-- </div> -->
</template>
<script>
import ThayDoiThongSoNe from './ThayDoiThongSoNe.vue'
...
export default {
  ...
  methods: {
    handleModal () {
      this.$bvModal.show('thongTinSoNe')
    }
  }
}
</script>
