<template>
  ...
  <ejs-grid
    ...
    :filterSettings="{showFilterBarOperator: false, mode: 'OnEnter', immediateModeDelay: 500}"
    locale="vi-VN"
    :allowSelection="true"
  ...
  >
    <e-columns>
      ...
      <e-column width="100" field="checkbox" :template="getCheckBoxTemplate" :visible="true"></e-column>
...
export default {
  ...
  props: {
    ...
    pageSettings: {
      ...
      default: () => {
        ...
        return { currentPage: 1, pageSize: 100, pageSizes: [5 ], pageCount: 5 }
      }
    }
  },
  data: function() {
  ...
  methods: {
    testClick() {
      this.$refs.grid.goToPage(2)
    },
    getCheckBoxTemplate(e) {
