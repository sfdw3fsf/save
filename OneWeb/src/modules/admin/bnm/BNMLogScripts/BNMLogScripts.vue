     ...
     // await this.testapi()
      try {
        ...
        var input = {
          ...
          from_date:moment(this.dtpTuNgay.value, "DD/MM/YYYY").format('DD-MM-YYYY'),  // '01-11-2023',//moment(this.dtpTuNgay.value).format('DD-MM-YYYY'),
          to_date: moment(this.dtpDenNgay.value, "DD/MM/YYYY").format('DD-MM-YYYY'), //'25-03-2024',//moment(this.dtpTuNgay.value).format('DD-MM-YYYY'),
        };
