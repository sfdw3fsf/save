export default{
    ...
    post_ds_baocao_quyen: async (axios, data) => axios.post('/web-quantri/quanlyquyen/sp_lay_ds_baocao_quyen', data),
    post_sp_action_ds_quyen_baocao: async (axios, data) => axios.post('/web-quantri/quanlyquyen/sp_action_ds_quyen_baocao', data),
  }