<template>
    <div class="main-wrapper">
        ...
        <Footer/>
        <!-- Modal -->
        <CreateDebtTableModal ref="createDebtTableModal"/>
...
import CreateDebtTableModal from './CreateDebtTableModal.vue'
export default {
    ...
    data(){
        return{
            header: {
                title: "Nhập thông tin xác nhận quyền",
                list: [
                    { 
                        name: "Lập hợp đồng", 
                        link: { name: "Ui.cards" },
    ...
    methods:{
        showModal(){
            this.$refs.createDebtTableModal.showModal()
        }
    }
}
</script>