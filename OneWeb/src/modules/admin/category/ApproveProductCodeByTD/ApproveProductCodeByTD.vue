<template src="./ApproveProductCodeByTD.html"></template>
<script>
...
export default {
  ...
  methods: {
    ...
    async timKiem() {
      ...
      let data = { "tag": 3, "nhomspdv_id": this.searchInfo.nhomspdv_id, "phuongthuc_id": this.searchInfo.phuongthuc_id, "donvi_id": donvi_id_1, "trangthai_id": this.searchInfo.trangthai_id, "ma_spdv": "", "ten_spdv": "" };
