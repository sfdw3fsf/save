<template src="./EmployeeAssignmentWard.html"></template>
<style src="./EmployeeAssignmentWard.scss" scoped></style>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      header: {
        title: "Gán nhân viên phường xã",
        list: [
          //{ name: 'Trang chủ', link: { name: 'Ui.cards' } },
          { name: "Quản lý nhân viên", link: { name: "Ui.cards" } },
          {
            name: "Gán nhân viên phường xã",
            link: { name: "Ui.cards" },
            active: true,
          },
        ],
