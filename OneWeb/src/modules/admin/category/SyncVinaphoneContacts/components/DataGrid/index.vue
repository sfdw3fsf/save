...
export default {
  ...
  methods: {    
    f3TimKiem(){
      this.$bvModal.show('modalF3TimKiem')
    },
    timKiem(){
      if(this.dataItems.length != 0)
        this.$bvModal.hide('modalF3TimKiem')
      else
        this.$toast.error('Không tìm thấy thông tin về mã TT/ mã TB: '+this.tuKhoa)
    },
