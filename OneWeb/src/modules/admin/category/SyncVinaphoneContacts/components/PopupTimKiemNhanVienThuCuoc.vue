...
export default {
    ...
    methods: {
        ...
        dialogOpen() {
            ...
            this.params.quan_Checked = (this.input['QUAN_ID'] && this.input['QUAN_ID']>0);
            if(this.input['QUAN_ID'] && this.input['QUAN_ID']>0) this.params.quan_Selected = this.input['QUAN_ID'];
            this.params.phuong_Checked = (this.input['PHUONG_ID'] && this.input['PHUONG_ID']>0);
            if(this.input['PHUONG_ID'] && this.input['PHUONG_ID']>0) this.params.phuong_Selected = this.input['PHUONG_ID'];
            this.params.pho_Checked = (this.input['PHO_ID'] && this.input['PHO_ID']>0);
            if(this.input['PHO_ID'] && this.input['PHO_ID']>0) this.params.pho_Selected = this.input['PHO_ID'];
        ...
        async initModal() {
            ...
            if (this.danhsachDonViGetter.length > 0) {
                ...
                if(this.dvql && this.dvql>0) {
                    this.params.donViQL_Selected = this.dvql; 
                    var list = this.params.donViQL_Options.filter(x=>x.id==this.params.donViQL_Selected);
