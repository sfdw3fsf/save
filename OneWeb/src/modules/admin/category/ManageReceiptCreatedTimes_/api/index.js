export default {
  ...
  sp_lay_ds_luottao_bienlai: (axios, data) => axios.post('/web-ccdv/tien_trinh_bao_hong/sp_lay_ds_luottao_bienlai', data),
  sp_lay_ds_bienlai_theo_luottao: (axios, data) => axios.post('/web-ccdv/tien_trinh_bao_hong/sp_lay_ds_bienlai_theo_luottao', data),
}
