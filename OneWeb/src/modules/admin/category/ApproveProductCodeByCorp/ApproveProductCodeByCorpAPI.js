export default{
    ...
    pheDuyetCapTct: async(axios, data) => axios.post('/web-qlspdv/ql_sanpham/fn_duyet_sanpham_cty', data),
    tuChoiDuyetCapTct: async(axios, data) => axios.post('/web-qlspdv/ql_sanpham/fn_tuchoi_sanpham_cty', data),
