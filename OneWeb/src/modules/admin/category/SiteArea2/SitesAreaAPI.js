...
export default {
  ...
  //update v2
  get_ds_pho_v3: (vphuong_id )=>axios.post('web-quantri/ql-diaban/sp_lay_ds_pho_v3', {vphuong_id}),
  // capnhat_log_khuvuc_lkv: (vkhuvuc_id, vdanhsach )=>axios.post('web-quantri/ql-diaban/capnhat_log_khuvuc_lkv', { vkhuvuc_id, vdanhsach }),
  // capnhat_log_khuvuc_px: (vkhuvuc_id, vdanhsach )=>axios.post('web-quantri/ql-diaban/fnc_capnhat_log_khuvuc_px', { vkhuvuc_id, vdanhsach }),
  insert_khuvuc_dv: (vkhuvuc_id, vnhanvien_id )=>axios.post('web-quantri/khuvuc_diadanh/sp_insert_khuvuc_dv', { vkhuvuc_id, vnhanvien_id }),
  get_ds_khuvuc_loai_kv: (vkhuvuc_id )=>axios.post('web-quantri/khuvuc_diadanh/sp_lay_ds_khuvuc_loai_kv', { vkhuvuc_id }),
  ktra_trunglap_frmkhuvuckm_v2: ( { vphuong_id, vpho_id, vap_id, vkhu_id, vdacdiem_id } )=>axios.post('web-quantri/khuvuc_diadanh/sp_ktra_trunglap_frmkhuvuckm_v2', { vphuong_id, vpho_id, vap_id, vkhu_id, vdacdiem_id }  ),
  nap_ds_dacdiem_frm_khuvuckm_v2: (vds_phuong_id, vds_pho_id ) => axios.post('web-quantri/khuvuc_diadanh/nap_ds_dacdiem_frm_khuvuckm_v2', { vds_phuong_id, vds_pho_id }),
  lay_ds_khuvuc_px_v2: (vkhuvuc_id)=> axios.post('web-quantri/khuvuc_diadanh/sp_lay_ds_khuvuc_px_v2', { vkhuvuc_id }),
}
