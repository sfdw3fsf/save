  ...
  methods: {
          ...
          template: Vue.component("columnTemplate", {
            ...
            watch: {
              model: async function(newval, oldval){
                  ...
                  console.log('thisdataaaaa1')
                  // console.log(this.$store.state.storeCat.employeesCommon.employees.employeesNotAdded)
                  console.log(this.data)
                  console.log(newval)
                  try {
                    let index = parent.dataGridNotAdded.dataSource.findIndex(item => item.nhanvien_id == this.data.nhanvien_id)
                    if (newval==true){
                      console.log('thisdataaaaa2')
                      parent.list_qg.push(this.data)
                      console.log(parent.list_qg)
    ...
    moveEmployeesToList: async function () {
      ...
      try {
        ...
        console.log(data)
        console.log('list_qg record')
        console.log(this.list_qg)
