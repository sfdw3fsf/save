...
<b-modal
  ...
  <div class="modal-content popup-box">
            <div class="popup-header">
                <div class="title">
                <span class="icon one-notepad"></span> Gán câu hỏi phụ
                </div>
                    ...
                    <div class="box-form">
                     ...
                     <div class="box-form">
                        ...
                        <div class="box-col box-form">
                            <div class="legend-title">Câu hỏi phụ chưa gán</div>
                        ...
                        <div class="box-col box-form">
                            <div class="legend-title">Câu hỏi phụ đã gán</div>
                            <div class="table-content">
                                  <k-table :columns="columnsGan" 
...
export default {
    ...
    methods:{
        ...
        showModal() {
            this.$refs["PopupCauHoiPhu"].show()
        },
        hideModal() {
            this.$refs["PopupCauHoiPhu"].hide()
        },
        handleShowModal(){
        ...
        onDataCheckedsChuaGan(data){
         ...
         boGan(){
          ...
          this.dataCheckedsGan.forEach((item)=>{
            ...
            const index =this.dataSourcesGan.findIndex(x=>x.cauhoi_id==item.cauhoi_id)
            if(index>-1){
        ...
        gan(){
          ...
          this.dataCheckedsChuaGan.forEach((item)=>{
            ...
            const index =this.dataSourcesChuaGan.findIndex(x=>x.cauhoi_id==item.cauhoi_id)
            if(index>-1){
        ...
        ganAll(){
         ...
         getDanhSach(){
            ...
            if(this.dataSourcesGan.length>0){
                this.dataSourcesGan.forEach((item, index)=>{
                     var row="#1"
                    row=row.replace("#1",item.cauhoi_id)
         ...
         async layDanhsachDavaChuaGan(loai) {
                this.loading(true)
                let rs = await this.axios.post("web-quantri/capnhatcauhoi/sp_lay_ds_cauhoiphu_load", {"rch_id": this.rch_id})
                if(loai == 0)
          ...
          async lay_danhsach_cauhoi_option() {
            ...
            async sp_update(data){
                ...
                this.loading(true)
                let response = await API.popup_CHP_ghilai(this.axios, data)
