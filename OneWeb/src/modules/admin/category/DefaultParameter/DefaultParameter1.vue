<template>
    <div class="main-wrapper">
        ...
        <Footer/>
        <!-- Modal -->
        <DefaultParameterModal ref="defaultParameterModal" />
    </div>
</template>
<script>
...
import DefaultParameterModal from './DefaultParameterModal.vue'
export default {
    ...
    methods:{
        showModal(){
            this.$refs.defaultParameterModal.showModal()
        }
    }
}
</script>