    ...
    <div class="popup-body">
        <div class="box-form" style="overflow: hidden;">
            <div class="info-row">
                ...
                <div class="value">
                    <input type="text" class="form-control"  :value="tieunganh.search" @change="v=>tieunganh.search=v.target.value">
                </div>
            </div>
...
<script>
import API from '../../../../contract/setup/InstallNewSubs/InstallNewSubsAPI'
export default {
    name: 'popupTieuNganh',
    props: [ 'dulieu' ],
    watch: {
    ...
    mounted() {
        if(this.dulieu.tieunganh) { 
            this.tieunganh.TNC1_ID = this.dulieu.tieunganh.TNC1_ID
            this.tieunganh.TNC2_ID = this.dulieu.tieunganh.TNC2_ID
            this.tieunganh.TNC3_ID = this.dulieu.tieunganh.TNC3_ID
            this.tieunganh.TNC4_ID = this.dulieu.tieunganh.TNC4_ID
        }        
