export default {
    ...
    tracuuSMS: async (axios, data,header) => axios.post('/tichhop/mediagw/inquire-qr-data-sms', data,header),
    fn_kiemtra_qr_thanhtoan: async (axios, data,header) => axios.post('/web-ccdv/tienhopdong/fn_kiemtra_qr_thanhtoan', data,header),
    genQRByMaGD: async (axios, data,header) => axios.post('/web-ccdv/tienhopdong/genQRByMaGD', data,header),
