export default {
    ...
    lay_ds_loaiGT: async (axios, data,header) => axios.post('/web-quantri/vnp08/dsLoaiGT', data,header),
    ...
    dsLoaiFile: async (axios, data,header) => axios.post('/web-quantri/vnp08/dsLoaiFile', data,header),
