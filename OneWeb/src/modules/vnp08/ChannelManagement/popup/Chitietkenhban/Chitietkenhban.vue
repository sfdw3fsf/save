<template src="./Chitietkenhban.html"></template>
<style scoped src="./Chitietkenhban.scss"></style>
<script>
  ...
  export default {
      ...
      methods:{
          showModal() {
              this.$refs["chitietkenhbanModal"].show()
          },
          hideModal() {
              this.$refs["chitietkenhbanModal"].hide()
          },
