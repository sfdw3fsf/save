<template src="./GanquyenUser.html"></template>
<style scoped src="./GanquyenUser.scss"></style>
<script>
 ...
 export default {
      ...
      methods:{
          showModal() {
              this.$refs["ganquyenUserModal"].show()
          },
          hideModal() {
              this.$refs["ganquyenUserModal"].hide()
          },
          changeFileUpload(){

          },
          ganQuyen(){
            console.log('ganQuyen')
          },
          goQuyen(){
            console.log('goQuyen')
          },
