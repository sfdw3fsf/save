...
export default {
  ...
  methods: {
   ...
   this.tenkhu = this.dsKhu.filter(
    ...
    chapnhan: function () {
      console.log(this.isPho)
      console.log(this.tenpho)
      console.log(this.isAp)
      console.log(this.tenap)
      console.log(this.isKhu)
      console.log(this.tenkhu)
      if (this.tenpho == "") {  
        this.$root.toastError("Hãy chọn Phố");
        return;
      }
