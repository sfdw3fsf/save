export default {
    ...
    dsDeXuatHopDongKenh: async (axios, data,header) => axios.post('/web-khdn/dxhopdong/dsDeXuatHopDongKenh', data,header),
    ...
    lichSuDxHopDong: async (axios, data,header) => axios.post('/web-khdn/dxhopdong/lichSuDxHopDong ', data,header),
    dsKenhBan: async (axios, data,header) => axios.post('/web-khdn/dxhopdong/dsKenhBan ', data,header),
