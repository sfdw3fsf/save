  ...
  >
    <div class="modal-content popup-box">
      ...
      <div class="popup-body">
        <div class="box-form">
          <div class="legend-title">Thông tin nợ khách hàng: {{ tenKH }}</div>
          <DataGrid
            :columns="fields"
            :dataSource="sources"
            :showFilter="true"
...
export default {
  ...
  methods: {
    ...
    close() {
      this.$bvModal.hide("modal-chitietnomotthuebao");
    },
    async fetchDanhSach() {
      const params = {
        kyCuoc: this.kyCuoc, //20210301
        maXLN: this.data.MA_XLN, //HPG-06-506987
