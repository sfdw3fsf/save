...
export default {
    ...
    methods: {
        ...
        async update() {
            ...
            try {
                ...
                let data = {
                    ...
                    pLoaiNhanVien: Loai_NV.NHANVIEN_PHAPLY,
                    pDSXLNId: dsxln_id1
                };
                ...
                if (
                    ...
                    for (const item of this.dtDotLay) {
                        if (this.gridDSKGanSelected.includes(item.MA_XLN)) {
                            ...
                            item.MANV_TC = this.cboNhanVienTC.find(
                                e => e.NHANVIEN_ID == this.cboNhanVienTCValue
                            ).TEN_HIENTHI;
                        }
                    }
        ...
        openDialog() {
            this.loadForm();
            this.$refs.dlgGanNhanVienPL.show();
            this.showListData();
        },
        closeDialog() {
            this.$refs.dlgGanNhanVienPL.hide();
        },
        reset() {
            this.dtTuyenThu = [];
            this.dtDotGiao = [];
        ...
        hienThiDS(dtLoad) {
            ...
            if (this.chkChuaGan) {
                if (
                    ...
                    dt = this.dtDotLay.filter(item => item.NHANVIEN_ID == 0);
                }
            } else {
                dt = this.dtDotLay;
            }
