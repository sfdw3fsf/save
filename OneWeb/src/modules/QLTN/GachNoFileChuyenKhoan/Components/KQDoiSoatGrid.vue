    ...
    <div class="table-content">
        <ejs-grid
            ...
            <e-columns>
                ...
                <e-column field='STATUS' headerTextAlign='Center' headerText='Trạng thái' textAlign='Left' width=100 :filterBarTemplate='templateOptions'></e-column>
            </e-columns>            
        </ejs-grid>
    </div>
</template>
...
export default Vue.extend({
    ...
    methods: {
        ...
        getCheckedRecords() {
            return this.$refs.kqDoiSoatGrid.getSelectedRecords();
        },

        exportExcel() {        
            this.$refs.kqDoiSoatGrid.excelExport();
        }
    },
