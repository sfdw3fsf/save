    ...
    <div class="table-content">
        <ejs-grid
            ...
            <e-columns>
                ...
                <e-column field='STT' headerTextAlign='Center' headerText='STT' textAlign='Right' width=60 :filterBarTemplate='templateOptions' isPrimaryKey='true'></e-column>
                ...
                <e-column field='LOI' headerTextAlign='Center' headerText='Lỗi' textAlign='Left' width=100 :filterBarTemplate='templateOptions'></e-column>
                <e-column field='STATUS' headerTextAlign='Center' headerText='' textAlign='Left' width=100 :filterBarTemplate='templateOptions'></e-column>
            </e-columns>            
        </ejs-grid>
    </div>
</template>
...
export default Vue.extend({
    ...
    methods: {
        ...
        exportExcel() {        
            this.$refs.kqKhongKhopGrid.excelExport();
        }
    },
