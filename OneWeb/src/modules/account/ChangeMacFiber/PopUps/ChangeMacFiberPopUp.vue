<template>
  <ejs-dialog :enableResize="true" :allowDragging="true" :visible="false" :animationSettings="animationSettings" ref="dialogObjChangeMacFiber" :position="position" :close="closeDialog" :header="'Thay đổi địa chỉ MAC FIBER'" showCloseIcon="true" width="900" target="#app .main-wrapper">
    <div class="">
      <div class="list-actions-top">
        <ul class="list">
          ...
          <li>
            <a href="#" @click.prevent="ThayDoi"> <span class="icon one-sync"></span>Thay đổi </a>
          </li>
          <li>
