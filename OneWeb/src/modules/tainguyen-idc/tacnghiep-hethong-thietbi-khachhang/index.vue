...
import ModalChiTietPhieuTacNghiepKhachHang from './chitiet-phieu-tacnghiep-khachhang/index.vue';

export default {
  name: 'TacNghiepHeThongThietBi',
  components: {
    ModalChiTietPhieuTacNghiepKhachHang
  },
  data() {
    return {
      loaiTacNghiepList: [],
  ...
  methods: {
    ...
    viewNhiemVu(data) {
      this.$refs.ModalChiTietPhieuTacNghiepKhachHang.show(data, 'VIEW');
    },

    xuLyNhiemVu(data) {
      this.$refs.ModalChiTietPhieuTacNghiepKhachHang.show(data, 'EDIT');
    },
