...
<script>
import Vue from 'vue'
import ModalChiTietThietBiTacNghiepKhachHang from '../chitiet-thietbi-tacnghiep-khachhang/index.vue';
export default {
    name: 'ModalChiTietPhieuTacNghiepKhachHang',
    props: { modalID: null },
    components: {
        ModalChiTietThietBiTacNghiepKhachHang
    },
    created: function () {
    ...
    methods: {
        closeModal: function () {
            this.$refs.ModalChiTietPhieuTacNghiepKhachHang.hide(this.modalID)
        },
        show: function (item, mode) {
            ...
            this.item = item;
            this.$refs.ModalChiTietPhieuTacNghiepKhachHang.show();
        },
            ...
            return function () {
                return {
                    template: {
                        ...
                        methods: {
                            onEdit: function () {
                                parent.$refs.ModalChiTietThietBiTacNghiepKhachHang.show();
                            }
                        }
                    },
