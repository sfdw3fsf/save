export default {
    getList: async (axios, loaiTbId) => axios.post(`web-ecms/idc/thietbi-hethong-khachhang/khachhang/${loaiTbId}`),

    getHDDetail: async (axios, hdtbId) => axios.post(`web-ecms/idc/thietbi-hethong-khachhang/hopdong/${hdtbId}`),
