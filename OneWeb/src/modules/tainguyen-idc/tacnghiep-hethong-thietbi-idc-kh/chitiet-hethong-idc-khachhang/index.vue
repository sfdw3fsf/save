  ...
  methods: {
    ...
    show: function(item, mode, modeFormThiCong) {
      ...
      if (typeof modeFormThiCong === 'object' && modeFormThiCong !== null) {
        ...
        this.currentItem.KHACH_HANG_TEN = modeFormThiCong.TEN_KH
        this.currentItem.SO_HOP_DONG = modeFormThiCong.SO_HD
        this.currentItem.MA_THUE_BAO = modeFormThiCong.MA_TB
    ...
    validateForm: function() {
      ...
      if (this.modeFormThiCong === 'LAPDAT' || this.modeFormThiCong === 'THAY_DOI_LAP_DAT') {
        ...
        if (!this.currentItem.KHACH_HANG_TEN && this.isKhachHang) {
          this.controls.txtKhachHang.invalid = true
          isValid = false
        }

        if (!this.currentItem.SO_HOP_DONG && this.isKhachHang) {
          this.controls.txtSoHopDong.invalid = true
          isValid = false
        }

        if (!this.currentItem.MA_THUE_BAO && this.isKhachHang) {
    ...
    updateItem: async function() {
      ...
      let dto = {
        ...
        nguoiQLId: this.currentItem.NHANVIEN_QL_ID ? +this.currentItem.NHANVIEN_QL_ID : null,
        donViQLId: this.currentItem.DONVI_QL_ID ? +this.currentItem.DONVI_QL_ID : null,
        ngayThaoGo: this.modeFormThiCong === 'LAPDAT' ? null : this.currentItem.NGAY_THAOGO
      }
