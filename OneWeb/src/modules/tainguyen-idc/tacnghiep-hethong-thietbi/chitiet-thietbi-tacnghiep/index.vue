...
export default {
    name: 'ModalChiThietThietBiTacNghiep',
    props: { modalID: null },
    components: {
    },
    created: function () {
    ...
    methods: {
        closeModal: function () {
            this.$refs.ModalChiThietThietBiTacNghiep.hide(this.modalID)
        },
        show: function (item, mode) {
            ...
            this.item = item;
            this.$refs.ModalChiThietThietBiTacNghiep.show();
        },
