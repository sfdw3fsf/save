<template>
  ...
  <ejs-grid
    ...
    @rowSelecting="grid_RowSelecting"
  ...
  >
    <e-columns>
      ...
      <!-- <e-column width="50px" field="abc" headerText="abcc" column="checkbox" :template="getCheckboxTemplate()" /> -->
...
import PaginationTemplate from './Pagination/index.js'
...
export default {
  ...
  props: {
    ...
    pageSettings: {
      type: Object,
      default: () => {
        // return { currentPage: 1, pageSize: 10, pageSizes: [5, 10, 20, 50, 100, 200, 300, 500], pageCount: 5 }
        return { currentPage: 1, pageSize: 10, pageSizes: [10, 50, 100, 200], pageCount: 5 }
      }
    }
  },
  data() {
  ...
  methods: {
    ...
    selectRecord(index) {
      let pageSize = this.$refs.grid.ej2Instances.properties.pageSettings.pageSize
      const toPage = parseInt(index / pageSize)
      const toRow = index % pageSize
      ...
      // console.log(toRow)
      setTimeout(() => {
                this.$refs.grid.goToPage(toPage + 1)
                setTimeout(() => {
                  this.$refs.grid.selectRow(toRow, false)
                  return true
                }, 200)
              }, 100)
     
    },
    getPaginationTemplate(e) {
      console.log('getPaginationTemplate')
      console.log(this)
      console.log(PaginationTemplate)
      return PaginationTemplate(this.$refs.grid)
    },
    // columnFilterTemplate: function(e) {
    //   return FilterTemplate(this.$refs.grid)
    // },
    // columnFilterTemplate: function(e) {
    //   return FilterTemplate(this.$refs.grid)
    // },
    ...
    contextMenuOpen: function(args) {
      this.$emit('contextMenuOpen', args)
    }
  }
}
</script>
