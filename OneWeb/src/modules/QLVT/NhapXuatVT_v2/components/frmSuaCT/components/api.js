export default {
    ...
    getDSMaKhoTD: async (axios) => axios.get(`/web-qlvt/api/nhapxuatvt_v2/sp_lay_ds_makhotd`),

    getDSVaTuHCM: (axios,data ) => axios.get(`/web-qlvt/api/tra-cuu-chung-tu/lay-ds-vattu-chungtu-hcm/${data.chungtu_id}`),


    //Giao Kho PSIS
    getDanhSachKhoPSIS: (axios ) => axios.post(`web-qlvt/api/nhapxuatvt_v2/sp_kho_giao_psis`,{}),
    saveKhoPSIS:(axios, {vchungtu_id, vkho_id} ) => axios.post(`web-qlvt/api/nhapxuatvt_v2/sp_kho_giao_psis`, {vchungtu_id, vkho_id}),
};