...
export default {
  ...
  methods: {
    ...
    onGridVatTuCellSaved(args) {
      console.log('onGridVatTuCellSaved')
      console.log(args)
      console.log(this.gridVatTu.dataSources)
      if (args) {
        ...
        //   })
        // }
        let changes = this.$refs.gridChiTietVatTu.getBatchChanges()
        this.$refs.gridChiTietVatTu.batchUpdate(changes)
        this.$refs.gridChiTietVatTu.grid.refreshColumns()
        //emit function
