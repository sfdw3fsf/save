...
export default {
  ...
  methods: {
    ...
    btnXacNhan() {
      ...
      console.log('this.gridDSVTGiao.dataSources')
      console.log(this.gridDSVTGiao.dataSources)
      console.log('this.gridVatTu.dataSources')
      console.log(this.gridVatTu.dataSources)

      this.gridDSVTGiao.dataSources.forEach((vtg) => {
        const vattu  = this.gridVatTu.dataSources.find(e=> e.VATTU_ID == vtg.VATTU_ID && e.LOHANG == vtg.LOHANG);
        // console.log('vattu')
        // console.log(vattu)
        // console.log('vattu?.LOHANG == vtg.LOHANG')
        // console.log(vattu?.LOHANG == vtg.LOHANG)
