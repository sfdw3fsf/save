  ...
  <div>
    <div class="detailRow">
      <div class="nav tabs tab-over">
        ...
        <a v-if="showTon" v-bind:href="tab2Link" data-toggle="tab" :class="{active: !showNguyenNhan}" class="detailRowTab">Chi tiết tồn</a>
        <a v-if="showNhanVien" v-bind:href="tab3Link" data-toggle="tab" :class="{active: !showNguyenNhan && !showTon}" class="detailRowTab">Chi tiết nhân viên thực hiện</a>
      </div>
      <div class="tab-content">
        ...
        <div v-if="showTon" v-bind:id="tab2" :class="{active: !showNguyenNhan}" class="tab-pane detailRowTabContent">
        ...
        <div v-if="showNhanVien" v-bind:id="tab3" :class="{active: !showNguyenNhan && !showTon}" class="tab-pane detailRowTabContent">
