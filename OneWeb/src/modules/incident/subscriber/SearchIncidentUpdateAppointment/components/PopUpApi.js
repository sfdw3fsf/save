export default {
  ...
  sp_kiemtra_tientrinh_sms: (axios, data) => axios.post(`/web-tracuu/tracuubaohong/sp_kiemtra_tientrinh_sms`, data),
  sp_capnhat_tientrinh_sms: (axios, data) => axios.post(`/web-tracuu/tracuubaohong/sp_capnhat_tientrinh_sms`, data),
  sp_capnhat_tientrinh_sms_v2: (axios, data) => axios.post(`/web-tracuu/tracuubaohong/sp_capnhat_tientrinh_sms_v2`, data),
  ...
  sp_lay_donvi_baohong: (axios, data) => axios.post(`/web-baohong/baohong/sp_lay_donvi_baohong`, data),
  sp_lay_nhanvien_baohong: (axios, data) => axios.post(`/web-baohong/baohong/sp_lay_nhanvien_baohong`, data), 
