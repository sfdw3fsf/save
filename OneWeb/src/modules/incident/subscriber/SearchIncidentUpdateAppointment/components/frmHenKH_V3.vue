    ...
    methods: {
        ...
        async capnhat_giohen() {
            ...
            let input = {
                ...
                vdonvi_id: donviId,
                vghichu_ton: this.txtGhiChu,
                vhensuatu: this.dtpNgayHenTu,
                vhensuaden: this.dtpNgayHenDen,
                vlydohen_id: this.cboLyDoHen
            }
            let kq = false;
            let data = await frmApi.capnhat_giohen_ttvt(this.axios, input);
            console.log(data)
