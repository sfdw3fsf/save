export default {
    ...
    ur_41003_5_003_01_lay_tt_baohong_theo_baohong_id: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/lay_tt_baohong_theo_baohong_id/${data.baohong_id}`, data, header),
    ...
    ur_41003_5_003_06_sp_tb_traloi_theo_tbtl_id: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/sp_tb_traloi_theo_tbtl_id/${data.tbtl_id}`, data, header),
    ur_41003_5_003_07_sp_tb_traloi_theo_baohong_id: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/sp_tb_traloi_theo_baohong_id/${data.baohong_id}`, data, header),

    ur_41003_5_004_01_lay_ds_cauhoi_theoloainv: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/lay_ds_cauhoi_theoloainv/${data.vnhanvien_id}/${data.vhinhthucks_id}`, data, header),
    ur_41003_5_004_02_sp_ct_tbtraloi: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/sp_ct_tbtraloi/${data.tbtl_id}`, data, header),

    ur_41003_5_006_kiemtra_xacnhan_ks: (axios, data) => axios.post('/web-ccdv/tien_trinh_bao_hong/kiemtra_xacnhan_ks', data),

    ur_41003_5_007_1_map_id: (axios, data) => axios.post('/web-ccdv/khaibaotsl/map_id', data),
    ur_41003_5_007_01_lay_ds_cauhoi_phu: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/lay_ds_cauhoi_phu/${data.rch_id}`, data, header),
    ur_41003_5_007_02_kiemtra_cauhoi_hailong: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/kiemtra_cauhoi_hailong/${data.rch_id}`, data, header),
    ur_41003_5_007_03_sp_ds_tb_traloi: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/sp_ds_tb_traloi/${data.traloi_id}`, data, header),
    ur_41003_5_007_04_sp_lay_ds_nhom_cauhoi_bh: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/sp_lay_ds_nhom_cauhoi_bh/${data.nhom_ch}`, data, header),
    ...
    ur_41003_5_008_12_kiemtra_phieu_quagio: (axios, data, header) => axios.get(`https://api-onebss-dev.vnptit3.vn/web-ccdv/tien_trinh_bao_hong/kiemtra_phieu_quagio/${data.giaophieu_ks_id}`, data, header),
