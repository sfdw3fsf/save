...
<template>
  <div>
    <ejs-dialog :enableResize="true" :allowDragging="true" :visible="false" :animationSettings="animationSettings" ref="frmPhanAnhBH" :position="position" :close="closeDialog" :header="'Phản ánh báo hỏng'" showCloseIcon="true" width="80%" target="#app .main-wrapper">
      <div id="frmPhanAnhBHDiv">
        <div class="list-actions-top">
          <ul class="list">
            <li>
              <a v-bind:class="{ disabled: !tsbNhapMoi_Enabled }" href="#" @click.prevent="tsbNhapMoi_Click"> <span class="icon ui-1_circle-remove nc-icon-glyph"></span> Nhập mới</a>
            </li>
            <li>
              <a v-bind:class="{ disabled: !tsbCapNhat_Enabled }" href="#" @click.prevent="tsbCapNhat_Click"> <span class="icon ui-1_circle-remove nc-icon-glyph"></span> Cập nhật</a>
            </li>
            <li>
            ...
            <div class="row">
              <div class="col-sm-6 col-12">
                ...
                <div class="info-row">
                  ...
                  <div class="value">
                    <input type="text" @keypress="isNumber($event)" v-model="txtDienThoaiLH" class="form-control fw6" />
                  </div>
                </div>
                <div class="info-row">
              ...
              <div class="col-sm-6 col-12">
                <div class="row">
                  <DataGrid :panelDataHeight="panelDataHeight" v-bind:columns="grdDanhSach_headers" :enabledSelectFirstRow="true" v-bind:dataSource="grdDanhSach.data" :showColumnCheckbox="false" :enable-paging-server="false" :allowPaging="true" :showFilter="true"> </DataGrid>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async LOAD_GRID_PHANANH() {
      ...
      let dsTTVT = await this.lay_tram_vt_baohong()
    ...
    async lay_tram_vt_baohong() {
      let input = { baohong_id: this.vbaohong_id_t }
      let data = this.GetData(await frmApi.lay_tram_vt_baohong(this.axios, input))
      return data
    },
