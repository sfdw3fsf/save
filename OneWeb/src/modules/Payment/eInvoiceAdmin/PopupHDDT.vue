  ...
  <div>
    ...
    >
      <template #modal-header="{ close }">
        <div class="title">
          <span class="icon nc-icon-outline ui-1_settings"></span> Hóa đơn điện
          tử
        </div>
        <div
          @click="close"
            ...
            <div class="box-form">
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
                    ...
                    <div class="value">
                      <div class="select-custom">
                        <SelectExt
                          v-model="ddlLoaiHopDong"
                          :options="this.options.loaihopdong"
                          :disabled="!this.chkLoaiHopDong"
                        >
                  ...
                  <div class="info-row">
                    ...
                    <div class="value">
                      <div class="select-custom">
                        <SelectExt
                          v-model="ddlDichVu"
                          :options="this.options.dichvu"
                          :disabled="!this.chkDichVu"
                        >
                          <option disabled value="0">Select one</option>
                        </SelectExt>
                      </div>
                  ...
                  <div class="info-row">
                    <div class="key w120">Tra cứu theo</div>
                    <div class="value">
                      <div class="select-custom">
                        <SelectExt
                          v-model="ddlTraCuuTheo"
                          :options="this.options.tracuutheo"
                        >
                          <option disabled value="0">Select one</option>
                        </SelectExt>
                      </div>
                ...
                <div class="col-sm-6 col-12">
                  ...
                  <div class="info-row">
                    ...
                    <div class="value">
                      <div class="select-custom">
                        <SelectExt
                          v-model="ddlTrangThaiHD"
                          :options="this.options.trangthaihd"
                          :disabled="!this.chkTrangThaiHD"
                        >
                          <option disabled value="0">Select one</option>
                        </SelectExt>
                      </div>
              ...
              <div class="legend-title mart20">Thông tin hợp đồng</div>
              <div class="row">
                <div class="col-sm-6 col-12">
                  <div class="info-row">
...
export default {
  ...
  methods: {
    ...
    async HienThiDanhSacHDKH() {
      ...
      if (this.txtThongTinTraCuu == "") dieukien = "0";
      else dieukien = this.ddlTraCuuTheo.replace(":values", this.txtThongTinTC);

      if (this.chkLoaiHopDong == true) this.frm.loaihd_id = this.ddlLoaiHopDong;
      else this.frm.loaihd_id = 0;

      if (this.chkDichVu == true) dichvuvt_id = this.ddlDichVu;
      else dichvuvt_id = 0;

      if (this.chkTrangThaiHD == true) tthd_id = this.ddlTrangThaiHD;
      else tthd_id = 0;
      ...
      console.log("danhsach", danhsach, this.options.dshd);
