  ...
  methods: {
    ...
    accept(){
      ...
      this.$emit('accept', Object.assign(data,{
        ...
        ten_tinh: this.tinh_created,
        ten_quan: this.quan_created,
        ten_phuong: this.phuong_created,
        ten_pho: this.pho_created,
        ten_ap: this.ap_created,
        ten_khu: this.khu_created,
        dacdiem: this.checkBox.dacdiem?this.danhSachDacDiem.find(x=>x.dacdiem_id==this.result.dacdiem_id).dacdiem:'',
