...
export default {
    ...
    methods: {
        ...
        chapNhan: async function () {
            this.closeModal({
                isUpdated: true, diaChi: this.diaChiForm, chiTietDiaChi: {
                    tinhThanh_id: this.tinhThanh_id,
                    quanHuyen_id: this.quanHuyen_id,
                    phuongXa_id: this.phuongXa_id,
                    duongPho_id: this.isChk_duongpho ? this.duongPho_id : null,
                    ap_id: this.isChk_ngoap ? this.ap_id : null,
                    khu_id: this.isChk_khu ? this.khu_id : null,
                    dacDiem_id: this.isChk_dacdiem ? this.dacDiem_id : null,
                    soNha: this.soNha
                }
            });
        },
    ...
    mounted: async function () {
        try {
            ...
            this.duongPho_id = this.chiTietDiaChi.duongPho_id;
                this.isChk_duongpho = this.duongPho_id > 0 ? true : false;
            this.ap_id = this.chiTietDiaChi.ap_id;
                this.isChk_ngoap = this.ap_id > 0 ? true : false;
            this.khu_id = this.chiTietDiaChi.khu_id;
                this.isChk_khu = this.khu_id > 0 ? true : false;
            this.dacDiem_id = this.chiTietDiaChi.dacDiem_id;
                this.isChk_dacdiem = this.dacDiem_id > 0 ? true : false;
