...
export default {
  ...
  computed: {
    ...
    dsHuongGiaoID: function () {
      ...
      if (!(this.danhSachHuongGiaoIDs == undefined || this.danhSachHuongGiaoIDs == '')) r = this.danhSachHuongGiaoIDs
      return r
    },
    kyCuoc: function () {
      let r = new Date()
      if (!(this.currentItem.kyCuoc == null || this.currentItem.kyCuoc == '')) r = DateTimeLib.toDateObjectWithFormat(this.currentItem.kyCuoc, 'YYYYMMDD')
      return r
    },
    enableBtnGiaoPhieu: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnGiaoPhieu') > -1
          if (result) {
            if (this.dsTTKNID != '12') {
    ...
    enableBtnGhiLai: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnGhiLai') > -1
        }
      }
      return result
    },
    enableBtnHoanThanh_GQKN: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnHoanThanh_GQKN') > -1
          if (result) {
            result = this.currentItem.ketQuaXuLy == 1
          }
        }
    ...
    enableBtnHoanThanh: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnHoanThanh') > -1
          if (result) {
            result = this.currentItem.ketQuaXuLy == 1
          }
        }
    ...
    enableBtnKhoaPhieu: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnKhoaPhieu') > -1
          if (result) {
            result = this.currentItem.ketQuaXuLy == 1
          }
        }
    ...
    enableBtnGiaoViec: function () {
      ...
      if (this.isToTruong) {
        if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
          if (this.dsThaoTacControl.length > 0) {
            result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbrnGiaoViec') > -1
    ...
    enableBtnHuyGiao: function () {
      ...
      if (this.isToTruong) {
        if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
          if (this.dsThaoTacControl.length > 0) {
            result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnHuyGiao') > -1
            if (result) result = this.isSelectedTabDaGiao()
          }
        }
      }
    ...
    enableBtnTraPhieu: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = !(this.dsThaoTacControl.findIndex((x) => x.ENABLE == 0 && x.CONTROL_NAME == 'tsbtnTraPhieu') > -1)
        }
      }
      return result
    },
    enableBtnGiaoPhoiHop: function () {
      ...
      if (!(this.dsThaoTacControl == null || this.dsThaoTacControl == undefined)) {
        if (this.dsThaoTacControl.length > 0) {
          result = this.dsThaoTacControl.findIndex((x) => x.ENABLE == 1 && x.CONTROL_NAME == 'tsbtnGiaoPhoiHop') > -1
        }
      }
      return result
    },
    ...
    enableBtnKetQuaKNMore: function () {
      ...
      if (this.currentItem.selectedKhieuNai != null) {
        result = this.currentItem.selectedKhieuNai.KETQUAKN_ID == 7 || this.currentItem.selectedKhieuNai.KETQUAKN_ID == 9
      }
      return result
    },
  ...
  methods: {
    ...
    getKyCuoc: async function () {
      let rs = await this.$root.context.get('/web-thuno/api/thu-no/common/ky-cuoc-hien-hanh')
      if (rs.data != null) if (rs.data.length > 0) if (!(rs.data[0].KYCUOC == null || rs.data[0].KYCUOC == undefined)) return rs.data[0].KYCUOC.toString()
      return ''
    },
    getTagValue: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getTagValue', {
        id: 600
      })
      return rs.data.TAGVALUE
    },
    getDsDichVu: async function () {
      let rs = await this.$root.context.post('/web-gqkn/TraCuuPhieuKN/sp_lay_ds_dichvu_vt')
      let result = rs.data
    ...
    getDsQuyTrinh: async function () {
      ...
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsQuyTrinh', {
    ...
    getDsChuDe: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsChuDe')
      let result = rs.data
      if (result == null || result == undefined) result = []
    ...
    getDsLoaiHinh: async function (dichVuVTID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsLoaiHinhTB', {
    ...
    getDsNhanVienThucHien: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsNhanVienXuLyKN')
      return rs.data
    },
    getDsPhuongAnXuLy: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsPhuongAnXuLy')
      return rs.data
    },
    getDsTBKhieuNai: async function (chudekn_id, trangthai) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsTBKhieuNai', {
    ...
    getDsKhieuNaiTheoTrangThai: async function (trangthai) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsKhieuNaiTheoTrangThai', {
        ttkn_id: this.dsTTKNID,
        huonggiao_id: this.dsHuongGiaoID,
        trangthai: trangthai,
        totruong: this.isToTruong ? 1 : 0 //1: QUYEN.TOTRUONG_XLKN
    ...
    getDsKhieuNaiKhac: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsKhieuNaiKhac', {
        ttkn_id: this.dsTTKNID,
        huonggiao_id: this.dsHuongGiaoID
      })
      if (!(rs.data == undefined || rs.data == null)) {
    ...
    comboboxDichVu_Change: async function () {
      this.dsLoaiHinhTB = await this.getDsLoaiHinh(this.$refs.comboboxDichVu.value)
    },
    // duẩn đổi api ds giảm trừ cước
    getDsGiamCuoc: async function (khieuNaiID) {
      let rs = await api.getGiamCuocKhieuNai(axios, khieuNaiID)
      return rs.data.data
    },
    getMaThanhToan: async function (thanhToanID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getMaThanhToan', {
        id: thanhToanID
      })
      return rs.data
    },
    getPhieuGiaoKhieuNai: async function (phieuKNID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getPhieuGiaoKhieuNai', {
        id: phieuKNID
      })
      return rs.data
    },
    getTuyenThu: async function (thanhToanID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getTuyenThu', {
        id: thanhToanID
      })
      return rs.data
    },
    getDonVi: async function (donViID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDonVi', {
        id: donViID
      })
      return rs.data
    },
    getNoiDungXacMinh: async function (khieuNaiID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getNoiDungXacMinh', {
        id: khieuNaiID
      })
      return rs.data
    },
    getDsKetQuaKN: async function () {
      let result = []
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsKetQuaKN', {
        id: 2
      })
      //BSS-72801
    ...
    getNguyenNhanKN: async function (chuDeKNID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getNguyenNhanKN', {
        id: chuDeKNID
      })
      return rs.data
    },
    getPhuongAnXL: async function (chuDeKNID) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getPhuongAnXL', {
        id: chuDeKNID
      })
      return rs.data
    },
    getDsHinhThucTraLoi: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsHinhThucTraLoi')
      return rs.data
    },
    capNhatTTGiaoViecKN: async function (khieunai_id, nhanvien_th_id, p_ngay_th, phieukn_id) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/capNhatTTGiaoViecKN', {
        khieunai_id: khieunai_id,
        nhanvien_th_id: nhanvien_th_id,
        p_ngay_th: DateTimeLib.toDateTimeDisplayWithFormat(p_ngay_th, 'YYYY-MM-DD HH:mm:ss'),
        phieukn_id: phieukn_id
      })
      return rs.data
    },
    capNhatXuLy: async function (httl_id, khieunai_id, macv, nd_ton, ngay_gq, nguyennhan, nhanvien_gq_id, noidung_gq) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/capNhatXuLy', {
        httl_id: httl_id,
        khieunai_id: khieunai_id,
        macv: macv,
        nd_ton: nd_ton,
        ngay_gq: DateTimeLib.toDateTimeDisplayWithFormat(ngay_gq, 'YYYY-MM-DD HH:mm:ss'),
    ...
    capNhatThongTinGiamCuoc: async function (khieuNaiID) {
      ...
      for (let i = 0; i < ds.length; i++) {
        const item = ds[i]
        dsXml += '<vt tgc="' + item.THANG_GC + '" tiengc="' + item.TIEN_GC + '" vat="' + item.VAT_GC + '" kygc="' + item.KY_GC + '" />'
      }
    ...
    capNhatTTPhieuGiao: async function (phieukn_id) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/capNhatTTPhieuGiao', {
        phieukn_id: phieukn_id,
        ttph_id: 4
      })
      return rs.data
    ...
    getThongTinHuongGiao: async function (quytrinh_id) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getThongTinHuongGiao', {
    ...
    getThongTinThaoTac: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getThongTinThaoTac', {
        id: this.luongID
      })
      return rs.data
    },
    ...
    kiemTraQuyenND: async function (quyen_id) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/kiemTraQuyenND', {
    ...
    getDsKyApDung: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsKyApDung')
      if (!(rs.data == undefined || rs.data == null)) {
        rs.data.forEach((e) => {
    ...
    getDsThangGC: async function (ma_tt, ma_tb) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/getDsThangGC', {
        ma_tt: ma_tt,
        ma_tb: ma_tb
      })
      if (!(rs.data == undefined || rs.data == null)) {
    ...
    getHuongGiaoTheoLuong: async function () {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/layHuongGiaoTheoLuong', {
        id: this.luongID
      })
      return rs.data
    },
    ...
    capNhatHTHS: async function (khieunai_id, phieukn_id, nhanvien_th_id, ngay_ht, ttkn_id, nguyennhan, traloi, ngay_gq) {
      let rs = await this.$root.context.post('/web-gqkn/xu-ly-khieu-nai/capNhatHTHS', {
        khieunai_id: khieunai_id,
        phieukn_id: phieukn_id,
        nhanvien_th_id: nhanvien_th_id,
        ngay_ht: DateTimeLib.toDateTimeDisplayWithFormat(ngay_ht, 'YYYY-MM-DD HH:mm:ss'),
        ttkn_id: ttkn_id,
        nguyennhan: nguyennhan,
        traloi: traloi,
        ngay_gq: DateTimeLib.toDateTimeDisplayWithFormat(ngay_gq, 'YYYY-MM-DD HH:mm:ss')
    ...
    loadDsKhieuNai: async function () {
      ...
      if (this.dsTTKNID == 3) {
        ...
        //}
        if (this.tabDsKhieuNaiSelected.ChuaGiao) this.dsThueBaoKhieuNaiChuaGiao = await this.getDsTBKhieuNai(0, 0)
        else this.dsThueBaoKhieuNaiDaGiao = await this.getDsTBKhieuNai(0, 1)
      }
    },
    gridDsThueBaoKhieuNaiChuaGiao_rowSelected: async function (args) {
      ...
      try {
        ...
        args.data.NGAY_TN_DATE = DateTimeLib.toDateTimeObjectWithFormat(args.data.NGAY_TN, 'YYYY-MM-DD HH:mm:ss')
        args.data.HENGQ_TU_DATE = DateTimeLib.toDateTimeObjectWithFormat(args.data.HENGQ_TU, 'YYYY-MM-DD HH:mm:ss')
        args.data.HENGQ_DEN_DATE = DateTimeLib.toDateTimeObjectWithFormat(args.data.HENGQ_DEN, 'YYYY-MM-DD HH:mm:ss')
        args.data.NGAY_GQ_DATE = args.data.NGAY_GQ == null ? new Date() : DateTimeLib.toDateTimeObjectWithFormat(args.data.NGAY_GQ, 'YYYY-MM-DD HH:mm:ss')
        if (args.data.NHANVIEN_GQ_ID == null || args.data.NHANVIEN_GQ_ID == 0) args.data.NHANVIEN_GQ_ID = this.$root.token.getNhanVienID()

        if (args.data.PAXL_ID == null || args.data.PAXL_ID == 0) args.data.PAXL_ID = 1

        if (args.data.KETQUAKN_ID == null || args.data.KETQUAKN_ID == 0) args.data.KETQUAKN_ID = 6
        ...
        this.dsThangGC = await this.getDsThangGC(args.data.MA_TT, args.data.MA_TB)
    ...
    getGioConLai: function (beginDate) {
      ...
      if (!(beginDate == undefined || beginDate == null || beginDate == '')) {
        let now = new Date()
        let bd = DateTimeLib.toDateTimeObjectWithFormat(beginDate, 'YYYY-MM-DD HH:mm:ss')
    ...
    btnGhiLai_Click: async function (args) {
      this.$root.showLoading(true)
      try {
        if (!this.checkEmptyString(this.currentItem.selectedKhieuNai.NGAY_GQ_DATE)) {
          let now = new Date()
          if (this.currentItem.selectedKhieuNai.NGAY_GQ_DATE > now) {
            ...
            if (this.currentItem.selectedKhieuNai.NGAY_TN_DATE > this.currentItem.selectedKhieuNai.NGAY_GQ_DATE) {
              this.$root.toastError('Bạn không được phép chọn ngày hoàn thành nhỏ hơn ngày tiếp nhận')
            } else {
              await this.capNhatTTGiaoViecKN(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.$root.token.getNhanVienID(), this.currentItem.selectedKhieuNai.NGAY_GQ_DATE, this.currentItem.selectedKhieuNai.PHIEUKN_ID)
              ...
              if (this.dsGiamCuoc.length > 0) {
                await this.capNhatThongTinGiamCuoc(this.currentItem.selectedKhieuNai.KHIEUNAI_ID)
              }
              if (this.checkPhaiLam('XACMINH')) {
                await this.capNhatThongTinXacMinh(this.currentItem.selectedKhieuNai.PHIEUKN_ID, this.$root.token.getNhanVienID(), this.currentItem.selectedKhieuNai.ND_XACMINH)
              }
              await this.loadDsKhieuNai()
    ...
    btnGiaoNV_Click: async function (args) {
      this.$root.showLoading(true)
      try {
        if (!(this.nhanVienThucHienID == 0 || this.nhanVienThucHienID == null)) {
          let rs = await this.giaoPhieuNhanVien(this.currentItem.selectedKhieuNai.PHIEUKN_ID, this.$root.token.getNhanVienID(), this.nhanVienThucHienID, this.currentItem.selectedKhieuNai.GHICHU_KN)
          if (!this.checkPhaiLam('XACMINH')) {
            await this.capNhatNhanVienThucHien(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.nhanVienThucHienID)
          }
          if (this.nhanTinGiaoViec) {
            await this.xuLyThongBaoNVTH(this.currentItem.selectedKhieuNai.PHIEUKN_ID)
    ...
    btnHuyGiaoNV_Click: async function (args) {
      ...
      try {
        if (this.checkPhaiLam('XACMINH')) {
          ...
          await this.huyNhanVienTH(this.currentItem.selectedKhieuNai.KHIEUNAI_ID)
        }
        if (this.nhanTinGiaoViec) {
          await this.xuLyThongBaoHuyGiao(this.currentItem.selectedKhieuNai.PHIEUKN_ID)
    ...
    btnHoanThanh_Click: async function (args) {
      this.$root.showLoading(true)
      try {
        if (this.checkEmptyNumber(this.currentItem.selectedKhieuNai.NHANVIEN_GQ_ID)) {
          this.$root.toastError('Bạn chưa chọn Nhân viên xử lý !')
        } else {
          if (this.checkEmptyString(this.currentItem.selectedKhieuNai.NOIDUNG_GQ)) {
            this.$root.toastError('Bạn chưa nhập nội dung trả lời khiếu nại !')
          } else {
            if (this.checkEmptyString(this.currentItem.selectedKhieuNai.NGUYENNHAN_KN)) {
              this.$root.toastError('Bạn chưa nhập nguyên nhân !')
            } else {
              if (this.checkPhaiLam('XACMINH') && this.checkEmptyString(this.currentItem.selectedKhieuNai.ND_XACMINH)) {
                ...
                if (t11 != 'ok') {
                  ...
                  let t1 = await this.kiemTraPhieuCon(this.currentItem.selectedKhieuNai.PHIEUKN_ID)
                  if (t1.RS > 0) {
                    this.$root.toastError('Vẫn còn phiếu con chưa thực hiện nên Bạn chưa được phép Hoàn thành!')
                  } else {
                    let huongGiaoID = 0
                    //TRANGTHAI_KHIEU_NAI.XU_LY_XONG = 5
                    let t2 = await this.getHuongGiao(this.currentItem.selectedKhieuNai.QUYTRINH_ID, 5)
                    if (t2 != null) {
                      huongGiaoID = t2.HUONGGIAO_ID
                    }

                    await this.capNhatPAXLDoHL(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.PAXL_ID, this.currentItem.selectedKhieuNai.HAILONG)

                    await this.capNhatKetQuaNoiDung(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.KETQUAKN_ID, this.currentItem.selectedKhieuNai.NOIDUNG_GQ)
                    await this.capNhatCongVan(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.CONGVAN_XL)

                    if (this.checkPhaiLam('XACMINH')) await this.capNhatThongTinXacMinh(this.currentItem.selectedKhieuNai.PHIEUKN_ID, this.$root.token.getNhanVienID(), this.currentItem.selectedKhieuNai.NOIDUNG_GQ)

                    await this.capNhatThongTinGiamCuoc(this.currentItem.selectedKhieuNai.KHIEUNAI_ID)

                    if (this.checkPhaiLam('TUDONG_HTHS')) {
                      await this.giaoPhieuKNKhiHC(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.PHIEUKN_ID, huongGiaoID, this.$root.token.getDonViID())
                      ...
                      if (this.themKHDBKhiKhieuNai) {
                        await this.capNhatKHDB(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.$root.token.getNhanVienID())
                      }
                      this.$root.toastSuccess('Bạn đã khóa phiếu khiếu nại thành công !')
                    } else {
                      await this.capNhatXuLyHT(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.CONGVAN_XL, '', new Date(), this.currentItem.selectedKhieuNai.NGUYENNHAN_KN, this.currentItem.selectedKhieuNai.NHANVIEN_GQ_ID, this.currentItem.selectedKhieuNai.NOIDUNG_GQ)
                      await this.giaoPhieuKNKhiHC(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.PHIEUKN_ID, huongGiaoID, this.currentItem.selectedKhieuNai.DONVI_ID)
                      await this.capNhatTTDaGiao(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, this.currentItem.selectedKhieuNai.PHIEUKN_ID, new Date(), this.currentItem.selectedKhieuNai.NHANVIEN_GQ_ID)
                      //TRANGTHAI_KHIEU_NAI.XU_LY_XONG = 5
                      await this.capNhatBaoTonHT(this.currentItem.selectedKhieuNai.KHIEUNAI_ID, new Date(), this.currentItem.selectedKhieuNai.NHANVIEN_GQ_ID, this.currentItem.selectedKhieuNai.NOIDUNG_GQ, '', this.$root.token.getDonViID(), 5)
        ...
        if (this.checkEmptyNumber(this.currentItem.selectedKhieuNai.NHANVIEN_GQ_ID)) {
          ...
          if (ck) {
            if (this.checkPhaiLam('XACMINH') && this.checkEmptyString(this.currentItem.selectedKhieuNai.ND_XACMINH)) {
              ...
              if (this.checkPhaiLam('XACMINH')) await this.capNhatThongTinXacMinh(this.currentItem.selectedKhieuNai.PHIEUKN_ID, this.$root.token.getNhanVienID(), this.currentItem.selectedKhieuNai.ND_XACMINH)
    ...
    btnGiamCuoc_Click() {
      let Link = this.$router.resolve({ path: 'de-xuat-giam-tru-cuoc', query: { MaKN: this.currentItem.selectedKhieuNai.MA_KN } })
    ...
    modalGiaoPhieuXacMinhPhoiHop_Shown: async function (args) {
      await this.$refs.formGiaoPhieuXacMinhPhoiHop.bindData(this.currentItem.selectedKhieuNai, this.nhanTinGiaoPhieuXLKN)
    },
    ...
    btnKetQuaLoi_Click: function (args) {
      if (this.currentItem.selectedKhieuNai.KETQUAKN_ID == 7) {
        this.$refs.modalNhanVienLoi.show(this.currentItem.selectedKhieuNai.KHIEUNAI_ID).then((result) => {
          if (result.ok) {
          } else {
          }
        })
      } else if (this.currentItem.selectedKhieuNai.KETQUAKN_ID == 9) {
        this.$refs.modalDonViLoi.show(this.currentItem.selectedKhieuNai.KHIEUNAI_ID).then((result) => {
          if (result.ok) {
          } else {
          }
        })
    ...
    modalGiaoPhieuKhieuNai_Shown: async function (args) {
      ...
      if (hgID != null) {
        await this.$refs.formGiaoPhieuKhieuNai.bindData(1, hgID.HUONGGIAO_ID, this.currentItem.selectedKhieuNai.MA_TB, 1, '0')
      } else {
    ...
    gridDsThueBaoKhieuNaiDaGiao_rowSelected: async function (args) {
      ...
      try {
        ...
        this.dsGiamCuoc = await this.getDsGiamCuoc(args.data.KHIEUNAI_ID)
        console.log('this.dsGiamCuoc', this.dsGiamCuoc)
      } finally {
        this.$root.showLoading(false)
      }
      //}
