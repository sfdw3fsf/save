...
export default {
   ...
   HinhThucThanhToan :
    ...
    DichVuVienThong:{
        ...
        // public static string[] listDichVuCoCap://Các dịnh vụ cần nhập cáp
        // {
        //     CO_DINH+"",ADSL+"",MEGAWAN+"",TSL+"",IMS+""
        // },
        // public static string[] listDichVuCNTT://Các dịnh vụ cần nhập cáp
        // {
        //     DICHVU_CNTT+"",TRUNGTAM_DULIEU+"",ANTOAN_BAOMAT_TT+"",HOINGHI_TRUYENHINH+""
        // },
    },
    KIEUGOI_CN_HOPDONG:
    {
