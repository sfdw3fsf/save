  ...
  methods: {
    ...
    async openDialog (tinh, ploaitb_ld, ploaitb, kieuld_id, pthongso_Ban, pthongso_TC, vloaihd, vkenhtrang) {
      try {
        ...
        console.log('this.tinhtc', this.tinhtc)
        ...
        if (temps && temps.length > 0) {
          ...
          // console.log('HT_LOAI_TB_LHTB_Combobox', this.thongso_Ban.thietbidc_id, this.thongso_Ban.thietbidc_id_cuoi)
          ...
          if (this.thongso_Ban.thietbidc_id_cuoi === undefined || this.thongso_Ban.thietbidc_id_cuoi === 0) {
            this.model.cboThietbiCuoiBan.value = temps[0].thietbidc_id
          } else {
