  ...
  methods: {
    ...
    getTramTC: async function () {
      try {
        ...
        console.log('🚀 ~ file: popupGanKhuVucQuanLyThueBao.vue ~ line 459 ~ rs', rs)
        this.options.tram_tc = rs.data !== null ? rs.data : []
      } catch (e) {
        console.log('🚀 ~ file: popupGanKhuVucQuanLyThueBao.vue ~ line 462 ~ e', e)
    ...
    getQuan: async function () {
      try {
        ...
        console.log('🚀 ~ file: popupGanKhuVucQuanLyThueBao.vue ~ line 469 ~ rs', rs)
