    ...
    async TaoDuLieu_HDTB_TSL (themmoi) {
      ...
      for (let i = 0; i < 2; i++) {
        ...
        if (i == 0) // Nếu là điểm đầu
        {
          ...
          rowHDTB_TSL.SITE_ID = this.txtSiteDau
        ...
        } else// Điểm cuối
        {
          ...
          rowHDTB_TSL.SITE_ID = this.txtSiteCuoi
      ...
      for (let i = 0; i < this.dsComboDonVi.length; i++) {
        ...
        if (item.loaiDonVi != Enum.LOAI_DV.TRAM_VT) {
          let row = {
