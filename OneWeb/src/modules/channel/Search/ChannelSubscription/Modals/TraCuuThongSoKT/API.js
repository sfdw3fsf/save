export default {
    ...
    sp_lay_ds_loai_tbi: async (axios, dichvuvt_id, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/sp_lay_ds_loai_tbi',{
    ...
    lay_ds_db_con_theo_tbid: async (axios, thuebao_id, dichvuvt_id, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/lay_ds_db_con_theo_tbid',{
    ...
    lay_tt_vatly_theo_port_logic: async (axios, port_id, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/lay_tt_vatly_theo_port_logic',{
        vport_id: port_id,
        phanvung_id: phanvung_id
    }),
    ...
    sp_ds_loai_tbi_theo_thuebao_id: async (axios, thuebao_id, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/sp_ds_loai_tbi_theo_thuebao_id',{
        vthuebao_id: thuebao_id,
        phanvung_id: phanvung_id
    }),

    fn_lay_text_huongketnoi_v2: async (axios, huong_kn, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/fn_lay_text_huongketnoi_v2',{
        huong_kn: huong_kn,
        phanvung_id: phanvung_id
    }),
    ...
    sp_lay_thongtin_lh_db_tsl: async (axios, thuebao_id, daucuoi_id, phanvung_id) => axios.post('/web-net/tracuuKenhLuong/sp_lay_thongtin_lh_db_tsl',{
        vthuebao_id: thuebao_id,
