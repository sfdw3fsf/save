...
<div>
        ...
        <div class="main-title">Tra cứu hợp đồng, phụ lục</div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Phát triển thuê bao</li>
            <li class="breadcrumb-item active">Tra cứu hợp đồng</li>
        </ul>
    </div>
      <SearchContract ref="SearchContract"/> 
</div>
