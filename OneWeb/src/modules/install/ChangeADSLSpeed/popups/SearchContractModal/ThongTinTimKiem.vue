<template>
  <div class="box-form">
    <div class="legend-title">
      <span  @click="clickShowHideTTTK" class="fa icon" :class="{'fa-angle-up':expandedThongTinTK, 'fa-angle-down':!expandedThongTinTK,}"></span>Thông tin tìm kiếm
    </div>
          ...
          <div class="value">
            <div class="select-custom">
              <!--<select v-model="loai_hd_selected" :disabled="!checkBoxs.loai_hd" class="form-control">
               ...
               <SelectExt v-model="loai_hd_selected"
                                    :allowFiltering="true" 
                                    :disabled="!checkBoxs.loai_hd"
                                    :dataSource="danhsach_loaihd"                               
                                    dataValueField="ID"
                                    dataTextField="NAME"
                                     >
              </SelectExt>
        ...
        <div class="info-row">
          ...
          <div class="value">
            ...
            <!--  <select v-model="tieuchi_selected" class="form-control">
               ...
               <SelectExt v-model="tieuchi_selected"
                                    :allowFiltering="true"
                                    :dataSource="danhsach_tieuchi"                               
                                    dataValueField="ID"
                                    dataTextField="NAME"
                                     >
              </SelectExt>
          ...
          <div class="value">
            <div class="select-custom">
             <!-- <select v-model="dichvu_selected" :disabled="!checkBoxs.dichvu" class="form-control">
              ...
              <SelectExt v-model="dichvu_selected"
                                    :allowFiltering="true" 
                                    :disabled="!checkBoxs.dichvu"
                                    :dataSource="danhsach_dv"                               
                                    dataValueField="ID"
                                    dataTextField="NAME"
                                     >
              </SelectExt>
          ...
          <div class="value">
            <div class="select-custom">
              <!--<select v-model="trangthai_hd_selected" :disabled="!checkBoxs.trangthai_hd" class="form-control">
               ...
               <SelectExt v-model="trangthai_hd_selected"
                                    :allowFiltering="true" 
                                    :disabled="!checkBoxs.trangthai_hd"
                                    :dataSource="danhsach_trangthai_hd"                               
                                    dataValueField="ID"
                                    dataTextField="NAME"
                                     >
              </SelectExt>
