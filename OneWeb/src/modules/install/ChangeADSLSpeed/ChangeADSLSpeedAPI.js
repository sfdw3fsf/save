export default{
  post_lay_muccuoc_adsl : async (axios, data) => axios.post('/web-hopdong/TocDoMucCuoc/lay_muccuoc_adsl', data),
  post_layds_kieutra : async (axios, data) => axios.post('/web-hopdong/TocDoMucCuoc/layds_kieutra', data),
