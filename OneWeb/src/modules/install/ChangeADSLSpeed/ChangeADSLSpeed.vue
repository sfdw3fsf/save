...
import ChangeADSLSpeedAPI from './ChangeADSLSpeedAPI'
...
export default {
  ...
  //props: [ 'kieuSPId' ],
  mounted () {
    ChangeADSLSpeedAPI.post_lay_muccuoc_adsl(this.axios,{}).then(
      (response) => {
          if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
            this.listbox.muccuoc_adsl.list = response.data.data;
          }
        }
    );
    ChangeADSLSpeedAPI.post_layds_kieutra(this.axios,{}).then(
      (response) => {
          if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
            this.listbox.kieutra.list = response.data.data;
          }
        }
    );
    ...
    //     },
    // });
    // ChangeADSLSpeedAPI.get_kieu_giao_hoso(this.axios,{}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    //     }
    // );
    // ChangeADSLSpeedAPI.get_donvi_giao_hoso(this.axios,{}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    //     }
    // );
    // ChangeADSLSpeedAPI.get_trangthai_ph(this.axios,{}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    //     }
    // );
    // ChangeADSLSpeedAPI.get_nhom_file(this.axios,{}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    //     }
    // );
    // ChangeADSLSpeedAPI.get_loai_file(this.axios,{}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
  ...
  methods: {
    ...
    //   ChangeADSLSpeedAPI.post_layds_bohoso_chuagiao_theo_makh_magd(this.axios, pdata).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    // },
    // LoadFile_HS() {
    //   ChangeADSLSpeedAPI.post_layds_file_trong_hoso(this.axios, {hoso_id:this.gridbox.bohoso.value.bohs_id}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    // },
    // NAP_DS_HOPDONGTB(){
    //   ChangeADSLSpeedAPI.post_lay_ds_hd_tb_theo_hdkh_id(this.axios, {vhdkh_id:this.gridbox.bohoso.value.hdkh_id}).then(
    //   (response) => {
    //       if(response && response.data && response.data.data && response.data.error_code && response.data.error_code === 'BSS-00000000' && response.data.data) {
    ...
    //   }
    //   ChangeADSLSpeedAPI.post_capnhat_file_hoso(this.axios,pdata).then((response) => {
    ...
    //   }
    //   ChangeADSLSpeedAPI.upload_file_hoso(this.axios,formData,{ headers: { 'Content-Type': 'multipart/form-data' } }).then((response) => {
