export default {
  ...
  udateObV2:  (axios, ds_para) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_ghilai`, { ds_para}  ),
  getListTBTraTruoc : (axios, sdt_tt, phanvung_id) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_lay_ds_tb_tratruoc`, { sdt_tt,phanvung_id }),
  getListTBTraSau: (axios, khachhang_id) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_lay_ds_tb_trasau`, { khachhang_id }),
  getListTBChuaHT : (axios, khachhang_id) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_lay_ds_hd_chua_ht`, { khachhang_id }),
  updateOBV2: (axios, ds_para) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_ghilai`, {ds_para}),
  getListOBHistory: (axios,phanvung_id, khachhang_id ) => axios.post(`web-tratruoc/ob_ghtt/fn_ghtt_ob_lay_ls_kq_ob`, { khachhang_id, phanvung_id }),
  updateUserIPCCState: (axios, userAuto) => axios.post(`tichhop/ipcc/updateUserState`, {userAuto}),
  getKieuYeuCau: (axios) => axios.get(`web-tracuu/tracuutonghop/lay_ds_tiepnhan_yc`),
}
