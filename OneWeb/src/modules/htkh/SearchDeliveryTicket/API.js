export default{
    ...
    traCuuDanhSachXuLyPhieu: (axios, data) => axios.post('/web-net/thongtinchung/traCuuDanhSachXuLyPhieu', data),
    hoanThanhPhieu: (axios, data) => axios.post('/web-net/thongtinchung/hoanThanhPhieu', data),
}
