<template>
    <ejs-dialog
        :enableResize="true"
        :allowDragging="true"
        ref="popup-frmLichSuHenBaoHong"
        :header="'Lịch sử hẹn báo hỏng'"
        showCloseIcon="true"
        width="70%"
        :visible="false"
        :open="dialogOpen"
...
export default {
    ...
    props: {
        ...
        id: {
            type: String,
            default: 'popup-frmLichSuHenBaoHong'
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        openDialog() {
            this.$refs["popup-frmLichSuHenBaoHong"].show();
        },
        closeDialog() {
            this.$refs["popup-frmLichSuHenBaoHong"].hide();
        },
        async onShow() {
