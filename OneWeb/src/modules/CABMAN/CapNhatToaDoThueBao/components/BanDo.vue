  ...
  watch: {
    mapTypeId (val) {
      ...
      if (this.mapTypeId === 'ROADMAP') {
        ...
        this.mapVNPT2.setStyle('https://maps.vnpt.vn/storage/vnptmaps/style/style_vetinh.json')
      } else {
        // this.mapTypeId = 'ROADMAP'
        this.mapVNPT2.setStyle('https://maps.vnpt.vn/tileserver/styles/mapvnpt_v2/style.json')
      }
