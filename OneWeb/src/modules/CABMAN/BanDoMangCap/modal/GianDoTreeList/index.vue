  ...
  methods: {
    ...
    PrintElem(elem, title, css) {
      ...
      this.build = function() {
        ...
        `
        tmpDoc.write(this.basicHtml5(this.htmlHead(this.htmlTitle(title) + this.styleTag(css) + this.styleTag(cssContent) + this.styleUrl('/static/css/app.css')) + this.htmlBody(document.querySelector(elem).innerHTML)))
