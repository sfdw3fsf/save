  ...
  methods: {
    ...
    async mapDataKetCuoi(data) {
      if (data != null) {
        ...
        if (this.dataSelected.ketcuoi_cha_id !== null && this.dataSelected.ketcuoi_cha_id !== '') {
          let rs = await this.$root.context.get('/web-cabman/ketcuoi/layThongtinKetCuoi?ketcuoi_id=' + this.dataSelected.ketcuoi_cha_id)
          if (rs.data != null) {
            this.tenKetCuoiCha = rs.data.TEN_KC
          } else {
            this.tenKetCuoiCha = ''
          }
        }
