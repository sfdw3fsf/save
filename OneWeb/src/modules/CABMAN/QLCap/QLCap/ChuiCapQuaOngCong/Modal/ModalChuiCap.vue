    ...
    methods: {
        ...
        getTuyenCongBe: async function () {
            try {
                ...
                this.dataSelected.tuyenCongBeId=this.dsTuyenCongBe[0].TUYENCB_ID
                this.getDoanCong()
            } catch (error) {
            } finally {
            }
        ...
        getDoanCong: async function () {
            try {
                ...
                this.dataSelected.doanCongId=this.dsDoanCong[0].DOANCONG_ID
            } catch (error) {
            } finally {
            }
        },
        ...
        goCap: async function () {
            try {
                ...
                for (let i = 0; i < this.dsCongDaChuiId.length; i++) {
                    let cong = this.dsCongDaChui.filter(
        ...
        chuiCap: async function () {
            try {
                ...
                for (let i = 0; i < this.dsCongChuaChuiId.length; i++) {
                    let cong = this.dsCongChuaChui.filter(
        ...
        capNhat: async function () {
            try {
                ...
                this.$root.showLoading(true);
                //if ((this.dsCongDaChui != null && this.dsCongDaChui.length > 0) || (this.dsCongDaChuiCu != null && this.dsCongDaChuiCu.length > 0)) {
                    let dsCong = []
                    ...
                    {
                        //this.dsCongDaChuiCu = this.dsCongDaChui
