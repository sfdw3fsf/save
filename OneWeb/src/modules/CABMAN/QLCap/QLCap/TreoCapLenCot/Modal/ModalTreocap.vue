    ...
    export default {
        ...
        methods: {
            ...
            capNhat: async function () {
                try {
                    //if ((this.dsCotDaTreo != null && this.dsCotDaTreo.length > 0) || (this.dsCotDaTreoCu != null && this.dsCotDaTreoCu.length > 0)) {
                        this.$root.showLoading(true);
                        let dsCot = []
                        ...
                        {
                            //this.dsCotDaTreoCu = this.dsCotDaTreo
