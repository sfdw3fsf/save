...
export const mutations = {
  ...
  set_gian_do_cong(state, data) {
    state.gian_do_cong = data;
  },

  set_gian_do_cot(state, data) {
    state.gian_do_cot = data;
  },

  set_ky_hieu_phan_biet_delete(state, data) {
    state.ky_hieu_phan_biet_delete = data;
  },
  ...
  clearState(state) {
    ...
    state.vdich_id = null;
    state.ky_hieu_phan_biet_delete = null;
  },
  ...
  set_node_focus(state, data) {
    state.node_focus = data;
  },
  //
};
