export default function(RequestContext) {
  return {
    ...
    api_get_ds_tuyen_cong: data =>
      RequestContext.get(
        `/web-cabman/BanDoTuyenCong/ds-tuyen-cong/${data.to_ql}`
      ),
    api_get_gian_do_tuyen_cong: data =>
      RequestContext.get(
        `/web-cabman/BanDoTuyenCong/gian-do-cong/${data}`
      ),
    api_get_gian_do_tuyen_cot: data =>
      RequestContext.get(
        `/web-cabman/bando_tuyencot/gian_do_cot/${data}`
      ),
  };
}
