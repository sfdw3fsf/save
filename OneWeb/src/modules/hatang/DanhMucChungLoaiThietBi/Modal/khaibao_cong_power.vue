<template src="./khaibao_cong_power.html">
</template>
    ...
    methods: {
        ...
        async dialogOpen() {
            try {
                ...
                if (this.$refs.dialogKhaiBaoCongPower) {
                    this.$refs.dialogKhaiBaoCongPower.show(); // Hiển thị dialog
                } else {
        ...
        closeDialog() {
            this.clearAll()
            this.$refs.dialogKhaiBaoCongPower.hide();
        },
