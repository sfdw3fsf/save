...
import { colsCongNguon, PHANLOAI_CONG, LOAICONG_ID, TRANGTHAI_KN } from '../../config.js'
...
export default {
  ...
  methods: {
    ...
    async onGeneratePowerPort() {
      ...
      this.$root.toastSuccess('Sinh cổng nguồn thành công')
    }
  }
}
</script>
