...
export default {
  ...
  computed: {
    ...
    focusTab() {
      return this.cardModuleInfo.isCardModuleMode ? this.cardModuleInfo.portType : this.currentTab
    },
    disabledLineNumber() {
    ...
    currentPortTypeList() {
      ...
      return portTypeMapping[this.focusTab] || []
    },
    deviceList() {
      const deviceMapping = {
      ...
      return deviceMapping[this.focusTab] || []
    }
  },
  watch: {},
  async created() {},
