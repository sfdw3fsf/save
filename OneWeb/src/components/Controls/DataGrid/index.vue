      ...
      if (this.columns != null) {
        for (let i = 0; i < this.columns.length; i++) {
          let column = {
            ...
            edit: this.columns[i].edit === undefined ? null : this.columns[i].edit,
      ...
      if (this.useAggregates) {
        for (let i = 0; i < this.aggregates.length; i++) {
          let column = {
            ...
            groupCaptionTemplate:this.aggregates[i].groupCaptionTemplate
          }
          allColumns.push(column)
        }
      }
